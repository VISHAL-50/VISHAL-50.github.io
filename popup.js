...
function M$1(a, b, e) {
  ...
  if (null != b)
    for (d2 in void 0 !== b.ref && (h = b.ref), void 0 !== b.key && (k2 = "" + b.key), b)
...
function R$1(a, b, e, d2, c) {
  ...
  if (h)
    return h = a, c = c(h), a = "" === d2 ? "." + Q$1(h, 0) : d2, I$1(c) ? (e = "", null != a && (e = a.replace(P$1, "$&/") + "/"), R$1(c, b, e, "", function(a2) {
      return a2;
  ...
  if (I$1(a))
    ...
    for (a = f2.call(a), g = 0; !(k2 = a.next()).done; )
      k2 = k2.value, f2 = d2 + Q$1(k2, g++), h += R$1(k2, b, e, f2, c);
  else if ("object" === k2)
...
react_production_min.cloneElement = function(a, b, e) {
  ...
  var d2 = C$1({}, a.props), c = a.key, k2 = a.ref, h = a._owner;
  if (null != b) {
  ...
  return { $$typeof: l$1, type: a.type, key: c, ref: k2, props: d2, _owner: h };
};
...
function q(c, a, g) {
  ...
  for (b in a)
    m$1.call(a, b) && !p$2.hasOwnProperty(b) && (d2[b] = a[b]);
  if (c && c.defaultProps)
...
(function(exports) {
    ...
    if (c !== b) {
      ...
      a:
        for (var d2 = 0, e = a.length, w2 = e >>> 1; d2 < w2; ) {
          ...
          if (0 > g(C2, c))
            n2 < e && 0 > g(x2, C2) ? (a[d2] = x2, a[n2] = c, d2 = n2) : (a[d2] = C2, a[m2] = c, d2 = m2);
  ...
  exports.unstable_scheduleCallback = function(a, b, c) {
    ...
    c > d2 ? (a.sortIndex = c, f2(t2, a), null === h(r2) && a === h(t2) && (B2 ? (E2(L2), L2 = -1) : B2 = true, K2(H2, c - d2))) : (a.sortIndex = e, f2(r2, a), A2 || z2 || (A2 = true, I2(J2)));
    return a;
  };
...
function Nb(a, b, c, d2, e, f2, g, h, k2) {
...
function Tb(a, b, c, d2, e, f2, g, h, k2) {
  Ob = false;
  Pb = null;
  Nb.apply(Sb, arguments);
}
function Ub(a, b, c, d2, e, f2, g, h, k2) {
...
function uc(a, b) {
  ...
  if (0 === c)
    return 0;
  var d2 = 0, e = a.suspendedLanes, f2 = a.pingedLanes, g = c & 268435455;
  if (0 !== g) {
    var h = g & ~e;
    0 !== h ? d2 = tc(h) : (f2 &= g, 0 !== f2 && (d2 = tc(f2)));
  } else
    g = c & ~e, 0 !== g ? d2 = tc(g) : 0 !== f2 && (d2 = tc(f2));
  if (0 === d2)
    return 0;
  if (0 !== b && b !== d2 && 0 === (b & e) && (e = d2 & -d2, f2 = b & -b, e >= f2 || 16 === e && 0 !== (f2 & 4194240)))
    return b;
  0 !== (d2 & 4) && (d2 |= c & 16);
  b = a.entangledLanes;
  if (0 !== b)
...
function Tc(a, b, c, d2, e, f2) {
  if (null === a || a.nativeEvent !== f2)
    return a = { blockedOn: b, domEventName: c, eventSystemFlags: d2, nativeEvent: f2, targetContainers: [e] }, null !== b && (b = Cb(b), null !== b && Fc(b)), a;
...
function Uc(a, b, c, d2, e) {
  switch (b) {
    ...
    case "pointerover":
      var f2 = e.pointerId;
      Oc.set(f2, Tc(Oc.get(f2) || null, a, b, c, d2, e));
      return true;
    case "gotpointercapture":
      return f2 = e.pointerId, Pc.set(f2, Tc(Pc.get(f2) || null, a, b, c, d2, e)), true;
  }
  return false;
}
function Vc(a) {
...
function nd() {
  if (md)
    return md;
  var a, b = ld, c = b.length, d2, e = "value" in kd ? kd.value : kd.textContent, f2 = e.length;
  for (a = 0; a < c && b[a] === e[a]; a++)
    ;
  var g = c - a;
  for (d2 = 1; d2 <= g && b[c - d2] === e[f2 - d2]; d2++)
    ;
  ...
  if (b !== c && c && c.ownerDocument && Le(c.ownerDocument.documentElement, c)) {
    if (null !== d2 && Ne(c)) {
      if (b = d2.start, a = d2.end, void 0 === a && (a = b), "selectionStart" in c)
        ...
        e && g && (1 !== a.rangeCount || a.anchorNode !== e.node || a.anchorOffset !== e.offset || a.focusNode !== g.node || a.focusOffset !== g.offset) && (b = b.createRange(), b.setStart(e.node, e.offset), a.removeAllRanges(), f2 > d2 ? (a.addRange(b), a.extend(g.node, g.offset)) : (b.setEnd(g.node, g.offset), a.addRange(b)));
      }
    }
    b = [];
    ...
    a: {
      ...
      if (b)
        for (var g = d2.length - 1; 0 <= g; g--) {
          var h = d2[g], k2 = h.instance, l2 = h.currentTarget;
          h = h.listener;
  ...
  Jb(function() {
    ...
    if (0 === (b & 7)) {
      ...
      if ($a = ce ? je(a, c) : ke(a, c))
        d3 = oe(d3, "onBeforeInput"), 0 < d3.length && (e2 = new Ld("onBeforeInput", "beforeinput", null, c, e2), g2.push({ event: e2, listeners: d3 }), e2.data = $a);
    }
    se(g2, b);
  });
}
...
function oe(a, b) {
  for (var c = b + "Capture", d2 = []; null !== a; ) {
    ...
    5 === e.tag && null !== f2 && (e = f2, f2 = Kb(a, c), null != f2 && d2.unshift(tf(a, f2, e)), f2 = Kb(a, b), null != f2 && d2.push(tf(a, f2, e)));
    a = a.return;
  }
  return d2;
}
...
function Og(a) {
  ...
  function m2(a2, b2, c2, d3, f3) {
    if (null === b2 || 7 !== b2.tag)
      return b2 = Tg(c2, a2.mode, d3, f3), b2.return = a2, b2;
    b2 = e(b2, c2);
    b2.return = a2;
    return b2;
  }
  ...
  function r2(a2, b2, c2, d3) {
    ...
    if ("object" === typeof c2 && null !== c2) {
      switch (c2.$$typeof) {
        case va:
          return c2.key === e2 ? k2(a2, b2, c2, d3) : null;
        case wa:
  ...
  function y2(a2, b2, c2, d3, e2) {
    ...
    if ("object" === typeof d3 && null !== d3) {
      switch (d3.$$typeof) {
        case va:
          return a2 = a2.get(null === d3.key ? c2 : d3.key) || null, k2(b2, a2, d3, e2);
        case wa:
          return a2 = a2.get(null === d3.key ? c2 : d3.key) || null, l2(b2, a2, d3, e2);
        case Ha:
          var f3 = d3._init;
          return y2(a2, b2, c2, f3(d3._payload), e2);
      }
      if (eb(d3) || Ka(d3))
  ...
  function t2(e2, g2, h2, k3) {
    ...
    for (m3 = d2(e2, m3); !n3.done; w2++, n3 = h2.next())
      ...
      switch (f3.$$typeof) {
        case va:
          a: {
            ...
            f3.type === ya ? (d3 = Tg(f3.props.children, a2.mode, h2, f3.key), d3.return = a2, a2 = d3) : (h2 = Rg(f3.type, f3.key, f3.props, null, a2.mode, h2), h2.ref = Lg(a2, d3, f3), h2.return = a2, a2 = h2);
          }
          return g(a2);
        case wa:
          a: {
          ...
          return g(a2);
        case Ha:
          return l3 = f3._init, J2(a2, d3, l3(f3._payload), h2);
      }
      if (eb(f3))
        return n2(a2, d3, f3, h2);
      if (Ka(f3))
        return t2(a2, d3, f3, h2);
      Mg(a2, f3);
    }
    return "string" === typeof f3 && "" !== f3 || "number" === typeof f3 ? (f3 = "" + f3, null !== d3 && 6 === d3.tag ? (c(a2, d3.sibling), d3 = e(d3, f3), d3.return = a2, a2 = d3) : (c(a2, d3), d3 = Qg(f3, a2.mode, h2), d3.return = a2, a2 = d3), g(a2)) : c(a2, d3);
  }
  return J2;
}
...
function Wh(a) {
  ...
  var d2 = N, e = d2.baseQueue, f2 = c.pending;
  if (null !== f2) {
    if (null !== e) {
      var g = e.next;
      e.next = f2.next;
...
function Zh(a, b) {
  var c = M, d2 = Uh(), e = b(), f2 = !He(d2.memoizedState, e);
...
function li(a, b, c, d2) {
  ...
  if (null !== N) {
    ...
    if (null !== d2 && Mh(d2, g.deps)) {
      e.memoizedState = bi(b, c, f2, d2);
      return;
    }
  }
  M.flags |= a;
  e.memoizedState = bi(1 | b, c, f2, d2);
}
function mi(a, b) {
...
function Fi(a, b, c, d2, e, f2, g) {
  a = a.stateNode;
  return "function" === typeof a.shouldComponentUpdate ? a.shouldComponentUpdate(d2, f2, g) : b.prototype && b.prototype.isPureReactComponent ? !Ie(c, d2) || !Ie(e, f2) : true;
}
function Gi(a, b, c) {
  var d2 = false, e = Vf;
  var f2 = b.contextType;
  "object" === typeof f2 && null !== f2 ? f2 = eh(f2) : (e = Zf(b) ? Xf : H.current, d2 = b.contextTypes, f2 = (d2 = null !== d2 && void 0 !== d2) ? Yf(a, e) : Vf);
  b = new b(c, f2);
...
function $i(a, b, c, d2, e) {
  if (null === a) {
    ...
    if ("function" === typeof f2 && !aj(f2) && void 0 === f2.defaultProps && null === c.compare && void 0 === c.defaultProps)
      return b.tag = 15, b.type = f2, bj(a, b, f2, d2, e);
...
function bj(a, b, c, d2, e) {
  if (null !== a) {
    ...
    if (Ie(f2, d2) && a.ref === b.ref)
      if (dh = false, b.pendingProps = d2 = f2, 0 !== (a.lanes & e))
...
function dj(a, b, c) {
  var d2 = b.pendingProps, e = d2.children, f2 = null !== a ? a.memoizedState : null;
  if ("hidden" === d2.mode)
    if (0 === (b.mode & 1))
    ...
    null !== f2 ? (d2 = f2.baseLanes | c, b.memoizedState = null) : d2 = c, G(ej, fj), fj |= d2;
  Xi(a, b, e, c);
  return b.child;
}
function gj(a, b) {
...
function hj(a, b, c, d2, e) {
  ...
  if (null === b.stateNode)
    ...
    q2 || "function" !== typeof g.UNSAFE_componentWillReceiveProps && "function" !== typeof g.componentWillReceiveProps || (h !== d2 || k2 !== l2) && Hi(b, g, d2, l2);
    jh = false;
    var r2 = b.memoizedState;
    g.state = r2;
    qh(b, d2, g, e);
    k2 = b.memoizedState;
    h !== d2 || r2 !== k2 || Wf.current || jh ? ("function" === typeof m2 && (Di(b, c, m2, d2), k2 = b.memoizedState), (h = jh || Fi(b, c, h, d2, r2, k2, l2)) ? (q2 || "function" !== typeof g.UNSAFE_componentWillMount && "function" !== typeof g.componentWillMount || ("function" === typeof g.componentWillMount && g.componentWillMount(), "function" === typeof g.UNSAFE_componentWillMount && g.UNSAFE_componentWillMount()), "function" === typeof g.componentDidMount && (b.flags |= 4194308)) : ("function" === typeof g.componentDidMount && (b.flags |= 4194308), b.memoizedProps = d2, b.memoizedState = k2), g.props = d2, g.state = k2, g.context = l2, d2 = h) : ("function" === typeof g.componentDidMount && (b.flags |= 4194308), d2 = false);
  } else {
    g = b.stateNode;
    lh(a, b);
    h = b.memoizedProps;
...
function oj(a, b, c) {
  var d2 = b.pendingProps, e = L.current, f2 = false, g = 0 !== (b.flags & 128), h;
  ...
  if (null === a) {
    ...
    g = d2.children;
    a = d2.fallback;
    return f2 ? (d2 = b.mode, f2 = b.child, g = { mode: "hidden", children: g }, 0 === (d2 & 1) && null !== f2 ? (f2.childLanes = 0, f2.pendingProps = g) : f2 = pj(g, d2, 0, null), a = Tg(a, d2, c, null), f2.return = b, a.return = b, f2.sibling = a, b.child = f2, b.child.memoizedState = nj(c), b.memoizedState = mj, a) : qj(b, g);
  }
  e = a.memoizedState;
  if (null !== e && (h = e.dehydrated, null !== h))
    return rj(a, b, g, d2, h, e, c);
  if (f2) {
    f2 = d2.fallback;
    g = b.mode;
    e = a.child;
    ...
    0 === (g & 1) && b.child !== e ? (d2 = b.child, d2.childLanes = 0, d2.pendingProps = k2, b.deletions = null) : (d2 = Pg(e, k2), d2.subtreeFlags = e.subtreeFlags & 14680064);
...
function rj(a, b, c, d2, e, f2, g) {
  if (c) {
    if (b.flags & 256)
      return b.flags &= -257, d2 = Ki(Error(p$1(422))), sj(a, b, g, d2);
...
function wj(a, b, c, d2, e) {
  ...
  null === f2 ? a.memoizedState = { isBackwards: b, rendering: null, renderingStartTime: 0, last: d2, tail: c, tailMode: e } : (f2.isBackwards = b, f2.rendering = null, f2.renderingStartTime = 0, f2.last = d2, f2.tail = c, f2.tailMode = e);
}
function xj(a, b, c) {
...
Bj = function(a, b, c, d2) {
  ...
  if (e !== d2) {
    ...
    for (l2 in d2) {
      ...
      if (d2.hasOwnProperty(l2) && k2 !== h && (null != k2 || null != h))
        if ("style" === l2)
          if (h) {
            for (g in h)
  ...
  switch (b.tag) {
        ...
        if (Gg(b)) {
          ...
          for (var g in f2)
            if (f2.hasOwnProperty(g)) {
              var h = f2[g];
              "children" === g ? "string" === typeof h ? d2.textContent !== h && (true !== f2.suppressHydrationWarning && Af(d2.textContent, h, a), e = ["children", h]) : "number" === typeof h && d2.textContent !== "" + h && (true !== f2.suppressHydrationWarning && Af(
                d2.textContent,
                h,
                a
    ...
    case 19:
      ...
      if (null === g)
        ...
        if (!d2)
          if (a = Ch(g), null !== a) {
            if (b.flags |= 128, d2 = true, c = a.updateQueue, null !== c && (b.updateQueue = c, b.flags |= 4), Dj(f2, true), null === f2.tail && "hidden" === f2.tailMode && !g.alternate && !I)
              return S(b), null;
          } else
            2 * B() - f2.renderingStartTime > Gj && 1073741824 !== c && (b.flags |= 128, d2 = true, Dj(f2, false), b.lanes = 4194304);
        f2.isBackwards ? (g.sibling = b.child, b.child = g) : (c = f2.last, null !== c ? c.sibling = g : b.child = g, f2.last = g);
      }
      if (null !== f2.tail)
        return b = f2.tail, f2.rendering = b, f2.tail = b.sibling, f2.renderingStartTime = B(), b.sibling = null, c = L.current, G(L, d2 ? c & 1 | 2 : c & 1), b;
      S(b);
      return null;
    case 22:
    case 23:
...
function gi(a, b, c, d2) {
  ...
  Ac(a, c, d2);
  if (0 === (K & 2) || a !== Q)
    a === Q && (0 === (K & 2) && (qk |= c), 4 === T && Ck(a, Z)), Dk(a, d2), 1 === c && 0 === K && 0 === (b.mode & 1) && (Gj = B() + 500, fg && jg());
}
function Dk(a, b) {
...
function Gk(a, b) {
  ...
  if (0 !== b) {
    ...
    if (6 === b)
      ...
      if (0 === (d2 & 30) && !Ok(e) && (b = Ik(a, d2), 2 === b && (f2 = xc(a), 0 !== f2 && (d2 = f2, b = Nk(a, f2))), 1 === b))
        throw c = pk, Kk(a, 0), Ck(a, d2), Dk(a, B()), c;
      a.finishedWork = e;
      a.finishedLanes = d2;
      switch (b) {
...
Vk = function(a, b, c) {
  ...
  switch (b.tag) {
    case 2:
      ...
      var f2 = Sh();
      b.flags |= 1;
      "object" === typeof e && null !== e && "function" === typeof e.render && void 0 === e.$$typeof ? (b.tag = 1, b.memoizedState = null, b.updateQueue = null, Zf(d2) ? (f2 = true, cg(b)) : f2 = false, b.memoizedState = null !== e.state && void 0 !== e.state ? e.state : null, kh(b), e.updater = Ei, b.stateNode = e, e._reactInternals = b, Ii(b, d2, a, c), b = jj(null, b, d2, true, f2, c)) : (b.tag = 0, I && f2 && vg(b), Xi(null, b, e, c), b = b.child);
      return b;
    case 16:
      d2 = b.elementType;
      a: {
    ...
    case 3:
      ...
      return b;
    case 5:
      return Ah(b), null === a && Eg(b), d2 = b.type, e = b.pendingProps, f2 = null !== a ? a.memoizedProps : null, g = e.children, Ef(d2, e) ? g = null : null !== f2 && Ef(d2, f2) && (b.flags |= 32), gj(a, b), Xi(a, b, g, c), b.child;
    case 6:
...
function bl(a, b, c, d2, e, f2, g, h, k2) {
  a = new al(a, b, c, h, k2);
...
function el(a, b, c, d2, e, f2, g, h, k2) {
  a = bl(c, d2, true, a, e, f2, g, h, k2);
  a.context = dl(null);
  c = a.current;
  d2 = R();
  e = yi(c);
...
reactDom_production_min.hydrateRoot = function(a, b, c) {
  if (!nl(a))
    throw Error(p$1(405));
  var d2 = null != c && c.hydratedSources || null, e = false, f2 = "", g = kl;
...
function convertSVG(abstractObj) {
  var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
  var _params$ceFn = params.ceFn, ceFn = _params$ceFn === void 0 ? abstractObj.tag === "svg" ? createElementNS : createElement$1 : _params$ceFn;
...
var render = function render2(iconDefinition) {
  var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
  var _params$transform = params.transform, transform = _params$transform === void 0 ? meaninglessTransform : _params$transform, _params$symbol = params.symbol, symbol = _params$symbol === void 0 ? false : _params$symbol, _params$mask = params.mask, mask = _params$mask === void 0 ? null : _params$mask, _params$maskId = params.maskId, maskId = _params$maskId === void 0 ? null : _params$maskId, _params$title = params.title, title = _params$title === void 0 ? null : _params$title, _params$titleId = params.titleId, titleId = _params$titleId === void 0 ? null : _params$titleId, _params$classes = params.classes, classes2 = _params$classes === void 0 ? [] : _params$classes, _params$attributes = params.attributes, attributes = _params$attributes === void 0 ? {} : _params$attributes, _params$styles = params.styles, styles2 = _params$styles === void 0 ? {} : _params$styles;
  if (!iconDefinition)
    return;
      ...
      layer: function layer2(assembler) {
        ...
        return domVariants({
          ...
          return [{
            tag: "span",
            attributes: {
              class: ["".concat(config.cssPrefix, "-layers")].concat(_toConsumableArray$1(classes2)).join(" ")
            },
            children
          }];
        });
  ...
  mixout: function mixout4() {
    return {
      counter: function counter2(content) {
        var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
        var _params$title = params.title, title = _params$title === void 0 ? null : _params$title, _params$classes = params.classes, classes2 = _params$classes === void 0 ? [] : _params$classes, _params$attributes = params.attributes, attributes = _params$attributes === void 0 ? {} : _params$attributes, _params$styles = params.styles, styles2 = _params$styles === void 0 ? {} : _params$styles;
        return domVariants({
          type: "counter",
          content
        }, function() {
          ...
          return makeLayersCounterAbstract({
            ...
            extra: {
              attributes,
              styles: styles2,
              classes: ["".concat(config.cssPrefix, "-layers-counter")].concat(_toConsumableArray$1(classes2))
            }
          });
        });
      }
        ...
        return domVariants({
          ...
          return makeLayersTextAbstract({
            ...
            extra: {
              attributes,
              styles: styles2,
              classes: ["".concat(config.cssPrefix, "-layers-text")].concat(_toConsumableArray$1(classes2))
            }
          });
        });
      }
...
function normalizeIconArgs(icon22) {
  ...
  if (icon22 && _typeof(icon22) === "object" && icon22.prefix && icon22.iconName) {
    return icon22;
  }
...
var FontAwesomeIcon = /* @__PURE__ */ React.forwardRef(function(props, ref) {
  ...
  var renderedIcon = icon2(iconLookup, _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, classes2), transform), mask), {}, {
    symbol,
    title,
    titleId,
    maskId
...
function animateCSSModeScroll(_ref2) {
  let {
    swiper,
    targetPosition,
    side
...
function Navigation(_ref2) {
  ...
  function toggleEl(el2, disabled2) {
...
function EffectCoverflow(_ref2) {
  let {
    swiper,
    extendParams,
    on
...
function slideTo(index, speed, runCallbacks, internal, initial2) {
  if (index === void 0) {
    index = 0;
  }
  if (runCallbacks === void 0) {
...
function mountSwiper(_ref2, swiperParams) {
  let {
    el: el2,
    nextEl,
    prevEl,
...
const Carousel = ({ videos, campaigns }) => {
  const carouselRef = reactExports.useRef(null);
  reactExports.useRef([]);
  reactExports.useState(false);
  const [popupVideoIndex, setPopupVideoIndex] = reactExports.useState(null);
  const [showPrevButton, setShowPrevButton] = reactExports.useState(false);
  const [showNextButton, setShowNextButton] = reactExports.useState(true);
  const handleVideoClick = (index) => {
    setPopupVideoIndex(index);
  };
  const handleClosePopup = () => {
    setPopupVideoIndex(null);
  };
  const scrollLeft = () => {
  ...
  const updateNavButtons = () => {
    const scrollLeft2 = carouselRef.current.scrollLeft;
    const maxScrollLeft = carouselRef.current.scrollWidth - carouselRef.current.clientWidth;
    setShowPrevButton(scrollLeft2 > 70);
    setShowNextButton(scrollLeft2 < maxScrollLeft - 70);
  };
  reactExports.useEffect(() => {
...
` }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Swiper2,
      {
        ...
        children: [
          videos.map((video, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SwiperSlide, { onClick: () => handleVideoClick(index), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "video-container123", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "carousel-div123", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "txt2-123", children: [
              ...
              " From",
              " ",
              campaigns[index].offerPrice.currency,
              campaigns[index].offerPrice.price
            ] }) })
          ] }) }, index) })),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "carousel", ref: carouselRef }),
    showNextButton && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "nav-btn123", onClick: scrollRight, children: ">" }),
    popupVideoIndex !== null && /* @__PURE__ */ jsxRuntimeExports.jsx(
      Popup,
      {
        campaigns,
        currentIndex: popupVideoIndex,
...
const Popup = ({ campaigns, currentIndex, onClose }) => {
  ...
  const [muteStatus, setMuteStatus] = reactExports.useState({});
  const [isVideoPaused, setIsVideoPaused] = reactExports.useState(false);
  const [showArrowIcon, setShowArrowIcon] = reactExports.useState(false);
  const [firstVideoDuration, setFirstVideoDuration] = reactExports.useState(null);
  const [showFullText, setShowFullText] = reactExports.useState(false);
  const videoRefs = reactExports.useRef([]);
  const arrowTimeout = reactExports.useRef(null);
  ...
  const handleNextCampaign = () => {
    if (currentCampaignIndex !== null) {
      if (currentCampaignIndex + 1 < campaigns.length) {
  ...
  const handlePreviousCampaign = () => {
    if (currentCampaignIndex !== null) {
      if (currentCampaignIndex > 0) {
        ...
        setCurrentCampaignIndex(campaigns.length - 1);
        setCurrentVideoIndex(0);
      }
    } else if (campaigns.length > 0) {
      setCurrentCampaignIndex(campaigns.length - 1);
  ...
  const handleLoadedMetadata = (index, video) => {
    if (index === 0) {
      setFirstVideoDuration(video.duration);
      startArrowIconTimeout(video.duration);
    }
  };
  const startArrowIconTimeout = (duration) => {
    clearTimeout(arrowTimeout.current);
  ...
  const handleVideoPlay = (index) => {
    clearTimeout(arrowTimeout.current);
    if (index === 0 && firstVideoDuration) {
      startArrowIconTimeout(firstVideoDuration);
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "whole123", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reelsContainer", children: campaigns[currentCampaignIndex].videoId.map((videoId, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reel", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "video-container", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "video",
          {
            ref: (el2) => videoRefs.current[index] = el2,
            src: videoId,
            className: "ad",
            loop: true,
            playsInline: true,
        ...
        isVideoPaused && /* @__PURE__ */ jsxRuntimeExports.jsx(
          FontAwesomeIcon,
          {
            icon: faPlay,
            onClick: () => handleVideoClick(index),
            className: "play-button123"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bookdiv123", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "img1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              className: "img",
              src: campaigns[currentCampaignIndex].campaignPhoto,
              alt: "Campaign"
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    style: { fontFamily: "Poppins, sans-serif" },
                    className: "hotelname",
                    children: campaigns[currentCampaignIndex].campaignName
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "pre",
                  {
                    ...
                    className: "offer",
                    children: [
                      showFullText ? campaigns[currentCampaignIndex].campaignDetails : truncateText(
                        campaigns[currentCampaignIndex].campaignDetails
                      ).truncated,
                      truncateText(
                        campaigns[currentCampaignIndex].campaignDetails
                      ).hasMore && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          style: { fontFamily: "Poppins, sans-serif" },
                          className: "view-more",
                          onClick: toggleText,
                          children: showFullText ? " View Less" : " View More"
                        }
                      ) })
                    ]
                  }
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "h2",
                  {
                    ...
                    children: [
                      "From ",
                      campaigns[currentCampaignIndex].offerPrice.currency,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divbtn", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: campaigns[currentCampaignIndex].hotelInfo.hotellink,
              target: "_blank",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "functions", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        FontAwesomeIcon,
        {
          icon: muteStatus[index] ? faVolumeMute : faVolumeUp,
          className: "volume123",
...
const App = () => {
  ...
  reactExports.useEffect(() => {
    const campaignId = "24c5e580-0291-1fb8-b7ef-97cd6d3971a2";
