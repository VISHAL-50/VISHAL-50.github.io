...
`}),y.jsx(F0,{videos:e,campaigns:n,loading:i,widgetsDiv:s})]})},B0=({campaigns:e,loading:t})=>{var P,z,D,B;const n=T.useRef(null),[r,i]=T.useState(!1),[o,s]=T.useState(null),[l,a]=T.useState(0),[c,f]=T.useState(!1),[p,m]=T.useState(0),[g,v]=T.useState({}),[w,b]=T.useState(!1);T.useEffect(()=>{const _=()=>{document.hidden&&n.current&&(n.current.muted=!0,f(!0))};return document.addEventListener("visibilitychange",_),()=>{document.removeEventListener("visibilitychange",_)}},[]),T.useEffect(()=>{const _=n.current,H=()=>{b(_.paused),_.paused&&_.play()};return _&&(_.addEventListener("play",H),_.addEventListener("pause",H)),()=>{_&&(_.removeEventListener("play",H),_.removeEventListener("pause",H))}},[o,l,e]),T.useEffect(()=>{if(o!==null&&e[o]){const _=e[o];if(l<_.videoId.length){const H=_.videoId[l];n.current.src=H,n.current.play(),m(0),b(!1)}}},[o,l,e]),T.useEffect(()=>{const _=setInterval(()=>{n.current&&m(n.current.currentTime/n.current.duration*100)},100);return()=>clearInterval(_)},[l,o]),T.useEffect(()=>{n.current&&(n.current.muted=c)},[c]);const u=_=>{s(_),a(0)},d=()=>{if(v(_=>({..._,[`${o}-${l}`]:!0})),m(100),o!==null&&e[o]){const _=e[o];l+1<_.videoId.length?a(l+1):o+1<e.length?(s(o+1),a(0)):(s(null),a(0))}},h=()=>{o!==null?o+1<e.length?(s(o+1),a(0)):(s(0),a(0)):e.length>0&&(s(0),a(0)),i(!1)},x=()=>{o!==null?o>0?(s(o-1),a(0)):(s(e.length-1),a(0)):e.length>0&&(s(e.length-1),a(0)),i(!1)},k=()=>{o!==null&&e[o]&&l+1<e[o].videoId.length&&(v(_=>({..._,[`${o}-${l}`]:!0})),a(l+1)),i(!1)},A=()=>{o!==null&&e[o]&&l>0&&a(l-1),i(!1)},N=()=>{f(_=>!_)},C=()=>{s(null),a(0),b(!1),f(!1)},M=_=>{const H=_.currentTarget.getBoundingClientRect(),L=_.clientX-H.left,j=H.width;L<j/2?A():k()},S=()=>{i(!r)},E=(_,H=65)=>_.length>H?{truncated:_.slice(0,H)+"...",hasMore:!0}:{truncated:_,hasMore:!1};return y.jsx(y.Fragment,{children:y.jsxs("div",{className:"storiesHeader",children:[y.jsx("div",{className:"outer",children:e.map((_,H)=>y.jsx("div",{onClick:()=>u(H),className:`inner ${o===H?"active":""} ${_.videoId.some((L,j)=>g[`${H}-${j}`])?"played":"not-played"}`,children:y.jsx("img",{src:_.campaignPhoto,alt:"Campaign",className:"campaign-photo",loading:"lazy"})},H))}),y.jsxs("div",{className:`topp ${o!==null?"active":""}`,children:[y.jsx("div",{className:"next",onClick:h,children:y.jsx(ie,{icon:Lo})}),y.jsx("div",{className:"previous",onClick:x,children:y.jsx(ie,{icon:Fo})}),y.jsx("div",{className:"outer-box",children:o!==null&&y.jsxs("div",{className:"boxed-video",children:[y.jsx("div",{className:"mute-unmute",onClick:N,children:c?y.jsx(ie,{icon:_o}):y.jsx(ie,{icon:Oo})}),y.jsx("div",{className:"close-button",onClick:C,children:y.jsx(ie,{className:"close",icon:jo})}),y.jsx("div",{className:"progress-bar",children:e[o].videoId.map((_,H)=>y.jsx("div",{className:"progress",children:y.jsx("div",{className:"progress1",style:{width:`${H===l?p:g[`${o}-${H}`]?100:0}%`}})},H))}),y.jsx("video",{className:"boxed-video",ref:n,playsInline:!0,onClick:M,onEnded:d,autoPlay:!0,children:"Your browser does not support the video tag."}),y.jsxs("div",{className:"bookdiv",children:[y.jsx("div",{className:"img1",children:y.jsx("img",{className:"img",src:e[o].campaignPhoto,alt:"Campaign",loading:"lazy"})}),y.jsxs("div",{style:{fontFamily:"Poppins, sans-serif"},className:"text",children:[y.jsx("p",{style:{fontFamily:"Poppins, sans-serif"},className:"hotelname",children:e[o].campaignName}),y.jsxs("pre",{style:{fontFamily:"Poppins, sans-serif"},className:"offer",children:[r?e[o].campaignDetails:E(e[o].campaignDetails,65).truncated,E(e[o].campaignDetails,65).hasMore&&y.jsx("div",{children:y.jsx("span",{style:{fontFamily:"Poppins, sans-serif"},className:"view-more",onClick:S,children:r?" View Less":" View More"})})]}),y.jsxs("div",{className:"bottom-div",children:[" ",((z=(P=e[o])==null?void 0:P.offerPrice)==null?void 0:z.currency)&&((B=(D=e[o])==null?void 0:D.offerPrice)==null?void 0:B.price)&&y.jsxs("h2",{style:{fontFamily:"Poppins, sans-serif"},className:"offerprice",children:["From"," ",e[o].offerPrice.currency,e[o].offerPrice.price]}),y.jsx("div",{className:"divbtn",children:y.jsx("a",{href:e[o].campaignLink,target:"_blank",rel:"noopener noreferrer",className:"bookbtn",children:"Book"})})]})]})]})]})})]})]})})};function V0(){T.useState([]);const[e,t]=T.useState([]);T.useState("");const[n,r]=T.useState(!0);return T.useEffect(()=>{const o=document.getElementById("root-stories").dataset.campaignId;o?(async l=>{try{const c=await(await fetch(`https://widgetapi.tripbuilder.in/${l}`)).json();t(c.campaigns)}catch(a){console.error("Error fetching data:",a)}})(o):console.log("no campaign id found!")},[]),T.useEffect(()=>{e.length>0&&r(!1)},[e]),y.jsxs("div",{className:"App1",children:[y.jsx("style",{children:`
        @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600&display=swap');
