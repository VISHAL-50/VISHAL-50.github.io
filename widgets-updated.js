...
const Popup = ({ campaigns, currentIndex, onClose }) => {
  ...
  const [userPaused, setUserPaused] = reactExports.useState(false);
  const videoRefs = reactExports.useRef([]);
  reactExports.useRef(null);
  const reelContainerRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
  ...
  const handleVideoEnded = (index) => {
    console.log("Video ended, checking if animation should play");
    const currentCampaign = campaigns[currentCampaignIndex];
    if (index < currentCampaign.videoId.length - 1) {
      console.log("Not the last video, playing animation");
      ...
      console.log("Last video, no animation, just restart");
      const video = videoRefs.current[index];
      if (video) {
        video.currentTime = 0;
        video.play();
  ...
  reactExports.useEffect(() => {
    ...
    if (reelContainer) {
      reelContainer.addEventListener("scroll", handleScroll);
    }
    return () => {
      if (reelContainer) {
        reelContainer.removeEventListener("scroll", handleScroll);
      }
    };
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "whole123", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reelsContainer", ref: reelContainerRef, children: [
      campaigns[currentCampaignIndex].videoId.map((videoId, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reel", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "video-container1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "video",
            {
          ...
          isVideoPaused && userPaused && /* @__PURE__ */ jsxRuntimeExports.jsx(
            FontAwesomeIcon,
            {
              icon: faPlay,
              onClick: () => handleStackClick(index),
