...
`}),y.jsx(Ay,{videos:e,campaigns:n,loading:i,widgetsDiv:s})," "]})},Ps=document.getElementById("root-stories"),Ns=document.getElementById("root-grid"),zs=document.getElementById("root-carosole"),Is=document.getElementById("root-stack");document.getElementById("root-popup");Ps&&Ps.dataset.name==="stories"&&Vn.createRoot(Ps).render(y.jsx(W.StrictMode,{children:y.jsx($0,{})}));Ns&&Ns.dataset.name==="grid"&&Vn.createRoot(Ns).render(y.jsx(W.StrictMode,{children:y.jsx(R0,{})}));zs&&zs.dataset.name==="carosole"&&Vn.createRoot(zs).render(y.jsx(W.StrictMode,{children:y.jsx(Py,{})}));Is&&Is.dataset.name==="stack"&&Vn.createRoot(Is).render(y.jsx(W.StrictMode,{children:y.jsx(ky,{})}));
