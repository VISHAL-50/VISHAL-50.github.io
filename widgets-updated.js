...
`}),v.jsx(Dv,{videos:e,campaigns:n,loading:i})]})},$v=()=>v.jsx("div",{className:"inner not-played",children:v.jsx("p",{className:"txt2-123"})}),Gv=({campaigns:e,loading:t})=>{const n=k.useRef(null),[r,i]=k.useState(!1),[o,s]=k.useState(null),[l,a]=k.useState(0),[u,d]=k.useState(!1),[p,h]=k.useState(0),[g,y]=k.useState({}),[w,b]=k.useState(!1);k.useEffect(()=>{const P=n.current,N=()=>{b(P.paused),P.paused&&P.play()};return P&&(P.addEventListener("play",N),P.addEventListener("pause",N)),()=>{P&&(P.removeEventListener("play",N),P.removeEventListener("pause",N))}},[o,l,e]),k.useEffect(()=>{if(o!==null&&e[o]){const P=e[o];if(l<P.videoId.length){const N=P.videoId[l];n.current.src=N,n.current.play(),h(0),b(!1)}}},[o,l,e]),k.useEffect(()=>{const P=setInterval(()=>{n.current&&h(n.current.currentTime/n.current.duration*100)},100);return()=>clearInterval(P)},[l,o]),k.useEffect(()=>{n.current&&(n.current.muted=u)},[u]);const c=P=>{s(P),a(0)},f=()=>{if(y(P=>({...P,[`${o}-${l}`]:!0})),h(100),o!==null&&e[o]){const P=e[o];l+1<P.videoId.length?a(l+1):o+1<e.length?(s(o+1),a(0)):(s(null),a(0))}},m=()=>{o!==null?o+1<e.length?(s(o+1),a(0)):(s(0),a(0)):e.length>0&&(s(0),a(0))},x=()=>{o!==null?o>0?(s(o-1),a(0)):(s(e.length-1),a(0)):e.length>0&&(s(e.length-1),a(0))},S=()=>{o!==null&&e[o]&&l+1<e[o].videoId.length&&(y(P=>({...P,[`${o}-${l}`]:!0})),a(l+1))},T=()=>{o!==null&&e[o]&&l>0&&a(l-1)},z=()=>{d(P=>!P)},A=()=>{s(null),a(0),b(!1),d(!1)},I=P=>{const N=P.currentTarget.getBoundingClientRect(),V=P.clientX-N.left,$=N.width;V<$/2?T():S()},C=()=>{i(!r)},j=P=>{const N=P.split(`
`);return N.length>2?{truncated:N.slice(0,2).join(`
`),hasMore:!0}:{truncated:P,hasMore:!1}};return t?v.jsx("div",{className:"storiesHeader ",children:v.jsx("div",{className:"outer ",children:Array.from({length:5}).map((P,N)=>v.jsx($v,{},N))})}):v.jsx(v.Fragment,{children:v.jsxs("div",{className:"storiesHeader",children:[v.jsx("div",{className:"outer",children:e.map((P,N)=>v.jsx("div",{onClick:()=>c(N),className:`inner ${o===N?"active":""} ${P.videoId.some((V,$)=>g[`${N}-${$}`])?"played":"not-played"}`,children:v.jsx("img",{src:P.campaignPhoto,alt:"Campaign",className:"campaign-photo"})},N))}),v.jsxs("div",{className:`topp ${o!==null?"active":""}`,children:[v.jsx("div",{className:"next",onClick:m,children:v.jsx(Y,{icon:ii})}),v.jsx("div",{className:"previous",onClick:x,children:v.jsx(Y,{icon:oi})}),v.jsx("div",{className:"outer-box",children:o!==null&&v.jsxs("div",{className:"boxed-video",children:[v.jsx("div",{className:"mute-unmute",onClick:z,children:u?v.jsx(Y,{icon:nr}):v.jsx(Y,{icon:tr})}),v.jsx("div",{className:"close-button",onClick:A,children:v.jsx(Y,{className:"close",icon:rr})}),v.jsx("div",{className:"progress-bar",children:e[o].videoId.map((P,N)=>v.jsx("div",{className:"progress",children:v.jsx("div",{className:"progress1",style:{width:`${N===l?p:g[`${o}-${N}`]?100:0}%`}})},N))}),v.jsx("video",{className:"boxed-video",ref:n,onClick:I,onEnded:f,autoPlay:!0,children:"Your browser does not support the video tag."}),v.jsxs("div",{className:"bookdiv",children:[v.jsx("div",{className:"img1",children:v.jsx("img",{className:"img",src:e[o].campaignPhoto,alt:"Campaign"})}),v.jsxs("div",{style:{fontFamily:"Poppins, sans-serif"},className:"text",children:[v.jsx("p",{style:{fontFamily:"Poppins, sans-serif"},className:"hotelname",children:e[o].campaignName}),v.jsxs("pre",{style:{fontFamily:"Poppins, sans-serif"},className:"offer",children:[r?e[o].campaignDetails:j(e[o].campaignDetails).truncated,j(e[o].campaignDetails).hasMore&&v.jsx("div",{children:v.jsx("span",{style:{fontFamily:"Poppins, sans-serif"},className:"view-more",onClick:C,children:r?" View Less":" View More"})})]}),v.jsxs("h2",{style:{fontFamily:"Poppins, sans-serif"},className:"offerprice",children:["From ",e[o].offerPrice.currency,e[o].offerPrice.price]})]}),v.jsx("div",{className:"divbtn",children:v.jsx("a",{href:e[o].hotelInfo.hotellink,target:"_blank",rel:"noopener noreferrer",className:"bookbtn",children:"Book"})})]})]})})]})]})})};function Uv(){k.useState([]);const[e,t]=k.useState([]);k.useState("");const[n,r]=k.useState(!0);return k.useEffect(()=>{const o=document.getElementById("root-stories").dataset.campaignId;o?(async l=>{try{const u=await(await fetch(`https://www.tripbuilder.in/php/shoppable.php/getCampaignsForHotel/${l}`)).json();t(u.campaigns)}catch(a){console.error("Error fetching data:",a)}})(o):console.log("no campaign id found!")},[]),k.useEffect(()=>{e.length>0&&r(!1)},[e]),v.jsxs("div",{className:"App1",children:[v.jsx("style",{children:`
