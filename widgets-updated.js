...
`}),v.jsx(Dv,{videos:e,campaigns:n,loading:i})]})},$v=()=>v.jsx("div",{className:"inner not-played",children:v.jsx("p",{className:"txt2-123"})}),Gv=({campaigns:e,loading:t})=>{const n=k.useRef(null),[r,i]=k.useState(!1),[o,s]=k.useState(null),[l,a]=k.useState(0),[u,d]=k.useState(!1),[p,h]=k.useState(0),[g,y]=k.useState({}),[x,b]=k.useState(!1);k.useEffect(()=>{const P=n.current,N=()=>{b(P.paused),P.paused&&P.play()};return P&&(P.addEventListener("play",N),P.addEventListener("pause",N)),()=>{P&&(P.removeEventListener("play",N),P.removeEventListener("pause",N))}},[o,l,e]),k.useEffect(()=>{if(o!==null&&e[o]){const P=e[o];if(l<P.videoId.length){const N=P.videoId[l];n.current.src=N,n.current.play(),h(0),b(!1)}}},[o,l,e]),k.useEffect(()=>{const P=setInterval(()=>{n.current&&h(n.current.currentTime/n.current.duration*100)},100);return()=>clearInterval(P)},[l,o]),k.useEffect(()=>{n.current&&(n.current.muted=u)},[u]);const c=P=>{s(P),a(0)},f=()=>{if(y(P=>({...P,[`${o}-${l}`]:!0})),h(100),o!==null&&e[o]){const P=e[o];l+1<P.videoId.length?a(l+1):o+1<e.length?(s(o+1),a(0)):(s(null),a(0))}},m=()=>{o!==null?o+1<e.length?(s(o+1),a(0)):(s(0),a(0)):e.length>0&&(s(0),a(0))},w=()=>{o!==null?o>0?(s(o-1),a(0)):(s(e.length-1),a(0)):e.length>0&&(s(e.length-1),a(0))},S=()=>{o!==null&&e[o]&&l+1<e[o].videoId.length&&(y(P=>({...P,[`${o}-${l}`]:!0})),a(l+1))},T=()=>{o!==null&&e[o]&&l>0&&a(l-1)},z=()=>{d(P=>!P)},A=()=>{s(null),a(0),b(!1),d(!1)},I=P=>{const N=P.currentTarget.getBoundingClientRect(),V=P.clientX-N.left,$=N.width;V<$/2?T():S()},C=()=>{i(!r)},j=P=>{const N=P.split(`
