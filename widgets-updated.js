 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(L,_){var R=L.length;L.push(_);e:for(;0<R;){var Z=R-1>>>1,ie=L[Z];if(0<i(ie,_))L[Z]=_,L[R]=ie,R=Z;else break e}}function n(L){return L.length===0?null:L[0]}function r(L){if(L.length===0)return null;var _=L[0],R=L.pop();if(R!==_){L[0]=R;e:for(var Z=0,ie=L.length,li=ie>>>1;Z<li;){var Qt=2*(Z+1)-1,Go=L[Qt],Kt=Qt+1,ai=L[Kt];if(0>i(Go,R))Kt<ie&&0>i(ai,Go)?(L[Z]=ai,L[Kt]=R,Z=Kt):(L[Z]=Go,L[Qt]=R,Z=Qt);else if(Kt<ie&&0>i(ai,R))L[Z]=ai,L[Kt]=R,Z=Kt;else break e}}return _}function i(L,_){var R=L.sortIndex-_.sortIndex;return R!==0?R:L.id-_.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var s=Date,l=s.now();e.unstable_now=function(){return s.now()-l}}var a=[],c=[],d=1,p=null,m=3,g=!1,y=!1,x=!1,C=typeof setTimeout=="function"?setTimeout:null,u=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function h(L){for(var _=n(c);_!==null;){if(_.callback===null)r(c);else if(_.startTime<=L)r(c),_.sortIndex=_.expirationTime,t(a,_);else break;_=n(c)}}function S(L){if(x=!1,h(L),!y)if(n(a)!==null)y=!0,se(k);else{var _=n(c);_!==null&&De(S,_.startTime-L)}}function k(L,_){y=!1,x&&(x=!1,u(P),P=-1),g=!0;var R=m;try{for(h(_),p=n(a);p!==null&&(!(p.expirationTime>_)||L&&!w());){var Z=p.callback;if(typeof Z=="function"){p.callback=null,m=p.priorityLevel;var ie=Z(p.expirationTime<=_);_=e.unstable_now(),typeof ie=="function"?p.callback=ie:p===n(a)&&r(a),h(_)}else r(a);p=n(a)}if(p!==null)var li=!0;else{var Qt=n(c);Qt!==null&&De(S,Qt.startTime-_),li=!1}return li}finally{p=null,m=R,g=!1}}var T=!1,z=null,P=-1,I=5,b=-1;function w(){return!(e.unstable_now()-b<I)}function E(){if(z!==null){var L=e.unstable_now();b=L;var _=!0;try{_=z(!0,L)}finally{_?N():(T=!1,z=null)}}else T=!1}var N;if(typeof f=="function")N=function(){f(E)};else if(typeof MessageChannel<"u"){var F=new MessageChannel,$=F.port2;F.port1.onmessage=E,N=function(){$.postMessage(null)}}else N=function(){C(E,0)};function se(L){z=L,T||(T=!0,N())}function De(L,_){P=C(function(){L(e.unstable_now())},_)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(L){L.callback=null},e.unstable_continueExecution=function(){y||g||(y=!0,se(k))},e.unstable_forceFrameRate=function(L){0>L||125<L?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):I=0<L?Math.floor(1e3/L):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return n(a)},e.unstable_next=function(L){switch(m){case 1:case 2:case 3:var _=3;break;default:_=m}var R=m;m=_;try{return L()}finally{m=R}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(L,_){switch(L){case 1:case 2:case 3:case 4:case 5:break;default:L=3}var R=m;m=L;try{return _()}finally{m=R}},e.unstable_scheduleCallback=function(L,_,R){var Z=e.unstable_now();switch(typeof R=="object"&&R!==null?(R=R.delay,R=typeof R=="number"&&0<R?Z+R:Z):R=Z,L){case 1:var ie=-1;break;case 2:ie=250;break;case 5:ie=1073741823;break;case 4:ie=1e4;break;default:ie=5e3}return ie=R+ie,L={id:d++,callback:_,priorityLevel:L,startTime:R,expirationTime:ie,sortIndex:-1},R>Z?(L.sortIndex=R,t(c,L),n(a)===null&&L===n(c)&&(x?(u(P),P=-1):x=!0,De(S,R-Z))):(L.sortIndex=ie,t(a,L),y||g||(y=!0,se(k))),L},e.unstable_shouldYield=w,e.unstable_wrapCallback=function(L){var _=m;return function(){var R=m;m=_;try{return L.apply(this,arguments)}finally{m=R}}}})(od);id.exports=od;var Am=id.exports;/**
 * @license React
...
`}),v.jsx(D0,{videos:e,campaigns:n,loading:i,widgetsDiv:s})]})},$0=()=>v.jsx("div",{className:"inner not-played",children:v.jsx("p",{className:"txt2-123"})}),G0=({campaigns:e,loading:t})=>{const n=A.useRef(null),[r,i]=A.useState(!1),[o,s]=A.useState(null),[l,a]=A.useState(0),[c,d]=A.useState(!1),[p,m]=A.useState(0),[g,y]=A.useState({}),[x,C]=A.useState(!1);A.useEffect(()=>{const E=()=>{document.hidden&&n.current?(n.current.muted=!0,d(!0)):video&&(n.current.muted=!1,d(!1))};return document.addEventListener("visibilitychange",E),()=>{document.removeEventListener("visibilitychange",E)}},[]),A.useEffect(()=>{const E=n.current,N=()=>{C(E.paused),E.paused&&E.play()};return E&&(E.addEventListener("play",N),E.addEventListener("pause",N)),()=>{E&&(E.removeEventListener("play",N),E.removeEventListener("pause",N))}},[o,l,e]),A.useEffect(()=>{if(o!==null&&e[o]){const E=e[o];if(l<E.videoId.length){const N=E.videoId[l];n.current.src=N,n.current.play(),m(0),C(!1)}}},[o,l,e]),A.useEffect(()=>{const E=setInterval(()=>{n.current&&m(n.current.currentTime/n.current.duration*100)},100);return()=>clearInterval(E)},[l,o]),A.useEffect(()=>{n.current&&(n.current.muted=c)},[c]);const u=E=>{s(E),a(0)},f=()=>{if(y(E=>({...E,[`${o}-${l}`]:!0})),m(100),o!==null&&e[o]){const E=e[o];l+1<E.videoId.length?a(l+1):o+1<e.length?(s(o+1),a(0)):(s(null),a(0))}},h=()=>{o!==null?o+1<e.length?(s(o+1),a(0)):(s(0),a(0)):e.length>0&&(s(0),a(0))},S=()=>{o!==null?o>0?(s(o-1),a(0)):(s(e.length-1),a(0)):e.length>0&&(s(e.length-1),a(0))},k=()=>{o!==null&&e[o]&&l+1<e[o].videoId.length&&(y(E=>({...E,[`${o}-${l}`]:!0})),a(l+1))},T=()=>{o!==null&&e[o]&&l>0&&a(l-1)},z=()=>{d(E=>!E)},P=()=>{s(null),a(0),C(!1),d(!1)},I=E=>{const N=E.currentTarget.getBoundingClientRect(),F=E.clientX-N.left,$=N.width;F<$/2?T():k()},b=()=>{i(!r)},w=E=>{const N=E.split(`
`);return N.length>2?{truncated:N.slice(0,2).join(`
`),hasMore:!0}:{truncated:E,hasMore:!1}};return t?v.jsx("div",{className:"storiesHeader ",children:v.jsx("div",{className:"outer ",children:Array.from({length:5}).map((E,N)=>v.jsx($0,{},N))})}):v.jsx(v.Fragment,{children:v.jsxs("div",{className:"storiesHeader",children:[v.jsx("div",{className:"outer",children:e.map((E,N)=>v.jsx("div",{onClick:()=>u(N),className:`inner ${o===N?"active":""} ${E.videoId.some((F,$)=>g[`${N}-${$}`])?"played":"not-played"}`,children:v.jsx("img",{src:E.campaignPhoto,alt:"Campaign",className:"campaign-photo"})},N))}),v.jsxs("div",{className:`topp ${o!==null?"active":""}`,children:[v.jsx("div",{className:"next",onClick:h,children:v.jsx(G,{icon:ri})}),v.jsx("div",{className:"previous",onClick:S,children:v.jsx(G,{icon:ii})}),v.jsx("div",{className:"outer-box",children:o!==null&&v.jsxs("div",{className:"boxed-video",children:[v.jsx("div",{className:"mute-unmute",onClick:z,children:c?v.jsx(G,{icon:tr}):v.jsx(G,{icon:er})}),v.jsx("div",{className:"close-button",onClick:P,children:v.jsx(G,{className:"close",icon:nr})}),v.jsx("div",{className:"progress-bar",children:e[o].videoId.map((E,N)=>v.jsx("div",{className:"progress",children:v.jsx("div",{className:"progress1",style:{width:`${N===l?p:g[`${o}-${N}`]?100:0}%`}})},N))}),v.jsx("video",{className:"boxed-video",ref:n,onClick:I,onEnded:f,autoPlay:!0,children:"Your browser does not support the video tag."}),v.jsxs("div",{className:"bookdiv",children:[v.jsx("div",{className:"img1",children:v.jsx("img",{className:"img",src:e[o].campaignPhoto,alt:"Campaign"})}),v.jsxs("div",{style:{fontFamily:"Poppins, sans-serif"},className:"text",children:[v.jsx("p",{style:{fontFamily:"Poppins, sans-serif"},className:"hotelname",children:e[o].campaignName}),v.jsxs("pre",{style:{fontFamily:"Poppins, sans-serif"},className:"offer",children:[r?e[o].campaignDetails:w(e[o].campaignDetails).truncated,w(e[o].campaignDetails).hasMore&&v.jsx("div",{children:v.jsx("span",{style:{fontFamily:"Poppins, sans-serif"},className:"view-more",onClick:b,children:r?" View Less":" View More"})})]}),v.jsxs("h2",{style:{fontFamily:"Poppins, sans-serif"},className:"offerprice",children:["From ",e[o].offerPrice.currency,e[o].offerPrice.price]})]}),v.jsx("div",{className:"divbtn",children:v.jsx("a",{href:e[o].campaignLink,target:"_blank",rel:"noopener noreferrer",className:"bookbtn",children:"Book"})})]})]})})]})]})})};function H0(){A.useState([]);const[e,t]=A.useState([]);A.useState("");const[n,r]=A.useState(!0);return A.useEffect(()=>{const o=document.getElementById("root-stories").dataset.campaignId;o?(async l=>{try{const c=await(await fetch(`https://www.tripbuilder.in/php/shoppable.php/getCampaignsForHotel/${l}`)).json();t(c.campaigns)}catch(a){console.error("Error fetching data:",a)}})(o):console.log("no campaign id found!")},[]),A.useEffect(()=>{e.length>0&&r(!1)},[e]),v.jsxs("div",{className:"App1",children:[v.jsx("style",{children:`
...
`}),v.jsxs("div",{className:"popupVideo",children:[v.jsx("div",{className:"popu-close-button",onClick:t,children:v.jsx(G,{icon:nr})}),v.jsx("video",{ref:s,src:c,autoPlay:!0,loop:!0,muted:n,onClick:()=>l(0)}),v.jsx("div",{className:"mute-unmute-button",onClick:d,children:v.jsx(G,{className:"mute",icon:n?tr:er})})]})]})]})},Iy=({campaigns:e,currentIndex:t,onClose:n})=>{const[r,i]=A.useState(t),[o,s]=A.useState(0),[l,a]=A.useState({}),[c,d]=A.useState(!1),[p,m]=A.useState(!1),[g,y]=A.useState(!1),[x,C]=A.useState(!1),u=A.useRef([]);A.useRef(null);const f=A.useRef(null),h=A.useRef(null);A.useEffect(()=>{const w=()=>{if(document.visibilityState==="hidden"){const E=u.current[o];E&&!E.paused&&(E.pause(),d(!0),C(!0))}};return document.addEventListener("visibilitychange",w),()=>{document.removeEventListener("visibilitychange",w)}},[o]),A.useEffect(()=>{const w=new IntersectionObserver(E=>{E.forEach(N=>{const F=u.current.indexOf(N.target);N.isIntersecting?(N.target.play(),s(F),C(!1)):N.target.pause()})},{threshold:.5});return s(0),u.current.forEach(E=>{E&&w.observe(E)}),()=>{u.current.forEach(E=>{E&&w.unobserve(E)})}},[r]),A.useEffect(()=>{const w=u.current[o];w&&w.play()},[o]);const S=()=>{r!==null?r+1<e.length?(i(r+1),s(0)):(i(0),s(0)):e.length>0&&(i(0),s(0)),m(!1)},k=()=>{r!==null?r>0?(i(r-1),s(0)):(i(e.length-1),s(0)):e.length>0&&(i(e.length-1),s(0)),m(!1)},T=w=>{const E=u.current[w];E&&(E.paused?(E.play(),console.log("Playing")):(E.pause(),console.log("Paused")),d(E.paused),C(E.paused))},z=w=>{const E=u.current[w];E&&(E.muted=!E.muted,a(N=>({...N,[w]:E.muted})))},P=()=>{y(!g)},I=w=>{const E=w.split(`
`);return E.length>2?{truncated:E.slice(0,2).join(`
`),hasMore:!0}:{truncated:w,hasMore:!1}},b=w=>{console.log("Video completely played"),w<e[r].videoId.length-1?m(!0):m(!1)};return A.useEffect(()=>{s(0),h.current&&(h.current.scrollTop=0)},[r]),A.useEffect(()=>{const w=()=>{m(!1)},E=h.current;return E&&E.addEventListener("scroll",w),()=>{E&&E.removeEventListener("scroll",w)}},[]),v.jsxs("div",{className:"whole123",ref:f,children:[v.jsx("div",{className:"prevbtn123",onClick:k,children:v.jsx(G,{icon:ii})}),v.jsx("div",{className:"nextbtn123",onClick:S,children:v.jsx(G,{icon:ri})}),v.jsxs("div",{className:"reelsContainer",ref:h,children:[e[r].videoId.map((w,E)=>v.jsxs("div",{className:"reel",children:[v.jsx("div",{className:"closediv123",children:v.jsx("button",{className:"closebtn123",onClick:n,children:v.jsx(G,{icon:nr})})}),v.jsxs("div",{className:"video-container1",children:[v.jsx("video",{ref:N=>u.current[E]=N,src:w,className:"ad",loop:!1,playsInline:!0,controls:!1,autoPlay:E===o,onClick:()=>T(E),onPause:()=>{d(!0)},onPlay:()=>{d(!1)},onEnded:()=>b(E)}),c&&x&&v.jsx(G,{icon:Ro,onClick:()=>T(E),className:"play-button123"}),v.jsxs("div",{className:"bookdiv123",children:[v.jsx("div",{className:"img1",children:v.jsx("img",{className:"img",src:e[r].campaignPhoto,alt:"Campaign"})}),v.jsxs("div",{style:{fontFamily:"Poppins, sans-serif"},className:"text",children:[v.jsx("p",{style:{fontFamily:"Poppins, sans-serif"},className:"hotelname",children:e[r].campaignName}),v.jsxs("pre",{style:{fontFamily:"Poppins, sans-serif"},className:"offer",children:[g?e[r].campaignDetails:I(e[r].campaignDetails).truncated,I(e[r].campaignDetails).hasMore&&v.jsx("div",{children:v.jsx("span",{style:{fontFamily:"Poppins, sans-serif"},className:"view-more",onClick:P,children:g?" View Less":" View More"})})]}),v.jsxs("h2",{style:{fontFamily:"Poppins, sans-serif"},className:"offerprice",children:["From ",e[r].offerPrice.currency,e[r].offerPrice.price]})]}),v.jsx("div",{className:"divbtn",children:v.jsx("a",{href:e[r].campaignLink,target:"_blank",rel:"noopener noreferrer",className:"bookbtn",children:"Book"})})]})]}),v.jsx("div",{className:"functions",children:v.jsx(G,{icon:l[E]?tr:er,className:"volume123",onClick:()=>z(E),style:{cursor:"pointer"}})})]},E)),p&&v.jsx("img",{src:"",alt:"",className:"down-arrow"})]})]})};function My(){const[e,t]=A.useState([]),[n,r]=A.useState(!0);A.useEffect(()=>{const s=document.getElementById("root-popup").dataset.campaignId;s?(async a=>{try{const d=await(await fetch(`https://www.tripbuilder.in/php/shoppable.php/getCampaignsForHotel/${a}`)).json();t(d.campaigns),console.log(d.campaigns[0].campaignDetails)}catch(c){console.error("Error fetching data:",c)}})(s):console.log("No campaign ID found!")},[]);const i=()=>{r(!1),console.log("close button")};return v.jsx(v.Fragment,{children:n&&v.jsx(im,{campaigns:e,onClose:i})})}const Ns=document.getElementById("root-stories"),zs=document.getElementById("root-grid"),Is=document.getElementById("root-carosole"),Ms=document.getElementById("root-stack"),Ls=document.getElementById("root-popup");Ns&&Ns.dataset.name==="stories"&&an.createRoot(Ns).render(v.jsx(U.StrictMode,{children:v.jsx(H0,{})}));zs&&zs.dataset.name==="grid"&&an.createRoot(zs).render(v.jsx(U.StrictMode,{children:v.jsx(B0,{})}));Is&&Is.dataset.name==="carosole"&&an.createRoot(Is).render(v.jsx(U.StrictMode,{children:v.jsx(zy,{})}));Ms&&Ms.dataset.name==="stack"&&an.createRoot(Ms).render(v.jsx(U.StrictMode,{children:v.jsx(Ay,{})}));Ls&&Ls.dataset.name==="popup"&&an.createRoot(Ls).render(v.jsx(U.StrictMode,{children:v.jsx(My,{})}));
