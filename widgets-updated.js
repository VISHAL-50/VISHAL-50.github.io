...
`}),y.jsx(D0,{videos:e,campaigns:n,loading:i,widgetsDiv:s})]})},B0=()=>y.jsx("div",{className:"inner not-played",children:y.jsx("p",{className:"txt2-123"})}),V0=({campaigns:e,loading:t})=>{const n=P.useRef(null),[r,i]=P.useState(!1),[o,s]=P.useState(null),[l,a]=P.useState(0),[c,d]=P.useState(!1),[p,m]=P.useState(0),[g,v]=P.useState({}),[w,k]=P.useState(!1);P.useEffect(()=>{const C=()=>{document.hidden&&n.current&&(n.current.muted=!0,d(!0))};return document.addEventListener("visibilitychange",C),()=>{document.removeEventListener("visibilitychange",C)}},[]),P.useEffect(()=>{const C=n.current,N=()=>{k(C.paused),C.paused&&C.play()};return C&&(C.addEventListener("play",N),C.addEventListener("pause",N)),()=>{C&&(C.removeEventListener("play",N),C.removeEventListener("pause",N))}},[o,l,e]),P.useEffect(()=>{if(o!==null&&e[o]){const C=e[o];if(l<C.videoId.length){const N=C.videoId[l];n.current.src=N,n.current.play(),m(0),k(!1)}}},[o,l,e]),P.useEffect(()=>{const C=setInterval(()=>{n.current&&m(n.current.currentTime/n.current.duration*100)},100);return()=>clearInterval(C)},[l,o]),P.useEffect(()=>{n.current&&(n.current.muted=c)},[c]);const u=C=>{s(C),a(0)},f=()=>{if(v(C=>({...C,[`${o}-${l}`]:!0})),m(100),o!==null&&e[o]){const C=e[o];l+1<C.videoId.length?a(l+1):o+1<e.length?(s(o+1),a(0)):(s(null),a(0))}},h=()=>{o!==null?o+1<e.length?(s(o+1),a(0)):(s(0),a(0)):e.length>0&&(s(0),a(0))},x=()=>{o!==null?o>0?(s(o-1),a(0)):(s(e.length-1),a(0)):e.length>0&&(s(e.length-1),a(0))},E=()=>{o!==null&&e[o]&&l+1<e[o].videoId.length&&(v(C=>({...C,[`${o}-${l}`]:!0})),a(l+1))},T=()=>{o!==null&&e[o]&&l>0&&a(l-1)},z=()=>{d(C=>!C)},A=()=>{s(null),a(0),k(!1),d(!1)},M=C=>{const N=C.currentTarget.getBoundingClientRect(),F=C.clientX-N.left,$=N.width;F<$/2?T():E()},S=()=>{i(!r)},b=C=>{const N=C.split(`
`);return N.length>2?{truncated:N.slice(0,2).join(`
`),hasMore:!0}:{truncated:C,hasMore:!1}};return t?y.jsx("div",{className:"storiesHeader ",children:y.jsx("div",{className:"outer ",children:Array.from({length:5}).map((C,N)=>y.jsx(B0,{},N))})}):y.jsx(y.Fragment,{children:y.jsxs("div",{className:"storiesHeader",children:[y.jsx("div",{className:"outer",children:e.map((C,N)=>y.jsx("div",{onClick:()=>u(N),className:`inner ${o===N?"active":""} ${C.videoId.some((F,$)=>g[`${N}-${$}`])?"played":"not-played"}`,children:y.jsx("img",{src:C.campaignPhoto,alt:"Campaign",className:"campaign-photo"})},N))}),y.jsxs("div",{className:`topp ${o!==null?"active":""}`,children:[y.jsx("div",{className:"next",onClick:h,children:y.jsx(ne,{icon:Lo})}),y.jsx("div",{className:"previous",onClick:x,children:y.jsx(ne,{icon:Do})}),y.jsx("div",{className:"outer-box",children:o!==null&&y.jsxs("div",{className:"boxed-video",children:[y.jsx("div",{className:"mute-unmute",onClick:z,children:c?y.jsx(ne,{icon:_o}):y.jsx(ne,{icon:Oo})}),y.jsx("div",{className:"close-button",onClick:A,children:y.jsx(ne,{className:"close",icon:jo})}),y.jsx("div",{className:"progress-bar",children:e[o].videoId.map((C,N)=>y.jsx("div",{className:"progress",children:y.jsx("div",{className:"progress1",style:{width:`${N===l?p:g[`${o}-${N}`]?100:0}%`}})},N))}),y.jsx("video",{className:"boxed-video",ref:n,onClick:M,onEnded:f,autoPlay:!0,children:"Your browser does not support the video tag."}),y.jsxs("div",{className:"bookdiv",children:[y.jsx("div",{className:"img1",children:y.jsx("img",{className:"img",src:e[o].campaignPhoto,alt:"Campaign"})}),y.jsxs("div",{style:{fontFamily:"Poppins, sans-serif"},className:"text",children:[y.jsx("p",{style:{fontFamily:"Poppins, sans-serif"},className:"hotelname",children:e[o].campaignName}),y.jsxs("pre",{style:{fontFamily:"Poppins, sans-serif"},className:"offer",children:[r?e[o].campaignDetails:b(e[o].campaignDetails).truncated,b(e[o].campaignDetails).hasMore&&y.jsx("div",{children:y.jsx("span",{style:{fontFamily:"Poppins, sans-serif"},className:"view-more",onClick:S,children:r?" View Less":" View More"})})]}),y.jsxs("h2",{style:{fontFamily:"Poppins, sans-serif"},className:"offerprice",children:["From ",e[o].offerPrice.currency,e[o].offerPrice.price]})]}),y.jsx("div",{className:"divbtn",children:y.jsx("a",{href:e[o].campaignLink,target:"_blank",rel:"noopener noreferrer",className:"bookbtn",children:"Book"})})]})]})})]})]})})};function $0(){P.useState([]);const[e,t]=P.useState([]);P.useState("");const[n,r]=P.useState(!0);return P.useEffect(()=>{const o=document.getElementById("root-stories").dataset.campaignId;o?(async l=>{try{const c=await(await fetch(`http://3.111.158.177:8000/${l}`)).json();t(c.campaigns)}catch(a){console.error("Error fetching data:",a)}})(o):console.log("no campaign id found!")},[]),P.useEffect(()=>{e.length>0&&r(!1)},[e]),y.jsxs("div",{className:"App1",children:[y.jsx("style",{children:`
