 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(E,L){var B=E.length;E.push(L);e:for(;0<B;){var j=B-1>>>1,O=E[j];if(0<i(O,L))E[j]=L,E[B]=O,B=j;else break e}}function n(E){return E.length===0?null:E[0]}function r(E){if(E.length===0)return null;var L=E[0],B=E.pop();if(B!==L){E[0]=B;e:for(var j=0,O=E.length,Q=O>>>1;j<Q;){var Ye=2*(j+1)-1,Go=E[Ye],qt=Ye+1,ai=E[qt];if(0>i(Go,B))qt<O&&0>i(ai,Go)?(E[j]=ai,E[qt]=B,j=qt):(E[j]=Go,E[Ye]=B,j=Ye);else if(qt<O&&0>i(ai,B))E[j]=ai,E[qt]=B,j=qt;else break e}}return L}function i(E,L){var B=E.sortIndex-L.sortIndex;return B!==0?B:E.id-L.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var s=Date,l=s.now();e.unstable_now=function(){return s.now()-l}}var a=[],u=[],d=1,p=null,h=3,g=!1,v=!1,w=!1,b=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(E){for(var L=n(u);L!==null;){if(L.callback===null)r(u);else if(L.startTime<=E)r(u),L.sortIndex=L.expirationTime,t(a,L);else break;L=n(u)}}function x(E){if(w=!1,m(E),!v)if(n(a)!==null)v=!0,W(S);else{var L=n(u);L!==null&&R(x,L.startTime-E)}}function S(E,L){v=!1,w&&(w=!1,c(A),A=-1),g=!0;var B=h;try{for(m(L),p=n(a);p!==null&&(!(p.expirationTime>L)||E&&!_());){var j=p.callback;if(typeof j=="function"){p.callback=null,h=p.priorityLevel;var O=j(p.expirationTime<=L);L=e.unstable_now(),typeof O=="function"?p.callback=O:p===n(a)&&r(a),m(L)}else r(a);p=n(a)}if(p!==null)var Q=!0;else{var Ye=n(u);Ye!==null&&R(x,Ye.startTime-L),Q=!1}return Q}finally{p=null,h=B,g=!1}}var T=!1,z=null,A=-1,I=5,C=-1;function _(){return!(e.unstable_now()-C<I)}function P(){if(z!==null){var E=e.unstable_now();C=E;var L=!0;try{L=z(!0,E)}finally{L?N():(T=!1,z=null)}}else T=!1}var N;if(typeof f=="function")N=function(){f(P)};else if(typeof MessageChannel<"u"){var V=new MessageChannel,$=V.port2;V.port1.onmessage=P,N=function(){$.postMessage(null)}}else N=function(){b(P,0)};function W(E){z=E,T||(T=!0,N())}function R(E,L){A=b(function(){E(e.unstable_now())},L)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(E){E.callback=null},e.unstable_continueExecution=function(){v||g||(v=!0,W(S))},e.unstable_forceFrameRate=function(E){0>E||125<E?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):I=0<E?Math.floor(1e3/E):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(a)},e.unstable_next=function(E){switch(h){case 1:case 2:case 3:var L=3;break;default:L=h}var B=h;h=L;try{return E()}finally{h=B}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(E,L){switch(E){case 1:case 2:case 3:case 4:case 5:break;default:E=3}var B=h;h=E;try{return L()}finally{h=B}},e.unstable_scheduleCallback=function(E,L,B){var j=e.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?j+B:j):B=j,E){case 1:var O=-1;break;case 2:O=250;break;case 5:O=1073741823;break;case 4:O=1e4;break;default:O=5e3}return O=B+O,E={id:d++,callback:L,priorityLevel:E,startTime:B,expirationTime:O,sortIndex:-1},B>j?(E.sortIndex=B,t(u,E),n(a)===null&&E===n(u)&&(w?(c(A),A=-1):w=!0,R(x,B-j))):(E.sortIndex=O,t(a,E),v||g||(v=!0,W(S))),E},e.unstable_shouldYield=_,e.unstable_wrapCallback=function(E){var L=h;return function(){var B=h;h=L;try{return E.apply(this,arguments)}finally{h=B}}}})(od);id.exports=od;var Am=id.exports;/**
 * @license React
...
`}),y.jsx(Dv,{videos:e,campaigns:n,loading:i})]})},$v=()=>y.jsx("div",{className:"inner not-played",children:y.jsx("p",{className:"txt2-123"})}),Gv=({campaigns:e,loading:t})=>{const n=k.useRef(null),[r,i]=k.useState(!1),[o,s]=k.useState(null),[l,a]=k.useState(0),[u,d]=k.useState(!1),[p,h]=k.useState(0),[g,v]=k.useState({}),[w,b]=k.useState(!1);k.useEffect(()=>{const P=n.current,N=()=>{b(P.paused),P.paused&&P.play()};return P&&(P.addEventListener("play",N),P.addEventListener("pause",N)),()=>{P&&(P.removeEventListener("play",N),P.removeEventListener("pause",N))}},[o,l,e]),k.useEffect(()=>{if(o!==null&&e[o]){const P=e[o];if(l<P.videoId.length){const N=P.videoId[l];n.current.src=N,n.current.play(),h(0),b(!1)}}},[o,l,e]),k.useEffect(()=>{const P=setInterval(()=>{n.current&&h(n.current.currentTime/n.current.duration*100)},100);return()=>clearInterval(P)},[l,o]),k.useEffect(()=>{n.current&&(n.current.muted=u)},[u]);const c=P=>{s(P),a(0)},f=()=>{if(v(P=>({...P,[`${o}-${l}`]:!0})),h(100),o!==null&&e[o]){const P=e[o];l+1<P.videoId.length?a(l+1):o+1<e.length?(s(o+1),a(0)):(s(null),a(0))}},m=()=>{o!==null?o+1<e.length?(s(o+1),a(0)):(s(0),a(0)):e.length>0&&(s(0),a(0))},x=()=>{o!==null?o>0?(s(o-1),a(0)):(s(e.length-1),a(0)):e.length>0&&(s(e.length-1),a(0))},S=()=>{o!==null&&e[o]&&l+1<e[o].videoId.length&&(v(P=>({...P,[`${o}-${l}`]:!0})),a(l+1))},T=()=>{o!==null&&e[o]&&l>0&&a(l-1)},z=()=>{d(P=>!P)},A=()=>{s(null),a(0),b(!1),d(!1)},I=P=>{const N=P.currentTarget.getBoundingClientRect(),V=P.clientX-N.left,$=N.width;V<$/2?T():S()},C=()=>{i(!r)},_=P=>{const N=P.split(`
`);return N.length>2?{truncated:N.slice(0,2).join(`
`),hasMore:!0}:{truncated:P,hasMore:!1}};return t?y.jsx("div",{className:"storiesHeader ",children:y.jsx("div",{className:"outer ",children:Array.from({length:5}).map((P,N)=>y.jsx($v,{},N))})}):y.jsx(y.Fragment,{children:y.jsxs("div",{className:"storiesHeader",children:[y.jsx("div",{className:"outer",children:e.map((P,N)=>y.jsx("div",{onClick:()=>c(N),className:`inner ${o===N?"active":""} ${P.videoId.some((V,$)=>g[`${N}-${$}`])?"played":"not-played"}`,children:y.jsx("img",{src:P.campaignPhoto,alt:"Campaign",className:"campaign-photo"})},N))}),y.jsxs("div",{className:`topp ${o!==null?"active":""}`,children:[y.jsx("div",{className:"next",onClick:m,children:y.jsx(Y,{icon:ii})}),y.jsx("div",{className:"previous",onClick:x,children:y.jsx(Y,{icon:oi})}),y.jsx("div",{className:"outer-box",children:o!==null&&y.jsxs("div",{className:"boxed-video",children:[y.jsx("div",{className:"mute-unmute",onClick:z,children:u?y.jsx(Y,{icon:nr}):y.jsx(Y,{icon:tr})}),y.jsx("div",{className:"close-button",onClick:A,children:y.jsx(Y,{className:"close",icon:rr})}),y.jsx("div",{className:"progress-bar",children:e[o].videoId.map((P,N)=>y.jsx("div",{className:"progress",children:y.jsx("div",{className:"progress1",style:{width:`${N===l?p:g[`${o}-${N}`]?100:0}%`}})},N))}),y.jsx("video",{className:"boxed-video",ref:n,onClick:I,onEnded:f,autoPlay:!0,children:"Your browser does not support the video tag."}),y.jsxs("div",{className:"bookdiv",children:[y.jsx("div",{className:"img1",children:y.jsx("img",{className:"img",src:e[o].campaignPhoto,alt:"Campaign"})}),y.jsxs("div",{style:{fontFamily:"Poppins, sans-serif"},className:"text",children:[y.jsx("p",{style:{fontFamily:"Poppins, sans-serif"},className:"hotelname",children:e[o].campaignName}),y.jsxs("pre",{style:{fontFamily:"Poppins, sans-serif"},className:"offer",children:[r?e[o].campaignDetails:_(e[o].campaignDetails).truncated,_(e[o].campaignDetails).hasMore&&y.jsx("div",{children:y.jsx("span",{style:{fontFamily:"Poppins, sans-serif"},className:"view-more",onClick:C,children:r?" View Less":" View More"})})]}),y.jsxs("h2",{style:{fontFamily:"Poppins, sans-serif"},className:"offerprice",children:["From ",e[o].offerPrice.currency,e[o].offerPrice.price]})]}),y.jsx("div",{className:"divbtn",children:y.jsx("a",{href:e[o].hotelInfo.hotellink,target:"_blank",rel:"noopener noreferrer",className:"bookbtn",children:"Book"})})]})]})})]})]})})};function Uv(){k.useState([]);const[e,t]=k.useState([]);k.useState("");const[n,r]=k.useState(!0);return k.useEffect(()=>{const o=document.getElementById("root-stories").dataset.campaignId;o?(async l=>{try{const u=await(await fetch(`https://www.tripbuilder.in/php/shoppable.php/getCampaignsForHotel/${l}`)).json();t(u.campaigns)}catch(a){console.error("Error fetching data:",a)}})(o):console.log("no campaign id found!")},[]),k.useEffect(()=>{e.length>0&&r(!1)},[e]),y.jsxs("div",{className:"App1",children:[y.jsx("style",{children:`
...
`}),y.jsx(rm,{effect:"coverflow",grabCursor:!0,centeredSlides:!0,loop:!0,slidesPerView:"auto",coverflowEffect:{rotate:0,stretch:0,depth:100,modifier:2.5},modules:[r1,e1,Jv],className:"swiper_container",children:n?Array.from({length:5}).map((w,b)=>y.jsx(Yl,{children:y.jsx(Ey,{})},b)):t.map((w,b)=>y.jsx(Yl,{onClick:()=>h(b),children:y.jsxs("div",{className:"video-container123",children:[y.jsx("div",{className:"inner-video-container123",onMouseEnter:()=>p(b),onMouseLeave:()=>p(null)}),d===b?y.jsx("video",{src:w.videoId[0],loop:!0,muted:!0,autoPlay:!0,playsInline:!0,className:"vid"}):y.jsx("img",{className:"thumbnail",src:w.campaignPhoto,width:"300",height:"200",alt:"video thumbnail"}),y.jsx("div",{className:"carousel-div123",children:y.jsxs("p",{className:"txt2-123",children:[w.campaignName," ",y.jsx("br",{})," From"," ",w.offerPrice.currency,w.offerPrice.price]})})]})},b))}),i!==null&&y.jsx(Cy,{campaigns:t,currentIndex:i,onClose:g})]})})},Cy=({campaigns:e,currentIndex:t,onClose:n})=>{const[r,i]=k.useState(t),[o,s]=k.useState(0),[l,a]=k.useState({}),[u,d]=k.useState(!1),[p,h]=k.useState(!1),[g,v]=k.useState(null),[w,b]=k.useState(!1),[c,f]=k.useState(!1),m=k.useRef([]),x=k.useRef(null);k.useRef(null);const S=k.useRef(null);k.useEffect(()=>{const R=new IntersectionObserver(E=>{E.forEach(L=>{const B=m.current.indexOf(L.target);L.isIntersecting?(L.target.play(),s(B),f(!1)):L.target.pause()})},{threshold:.5});return s(0),m.current.forEach(E=>{E&&R.observe(E)}),()=>{m.current.forEach(E=>{E&&R.unobserve(E)})}},[r]),k.useEffect(()=>{const R=m.current[o];R&&R.play()},[o]);const T=()=>{r!==null?r+1<e.length?(i(r+1),s(0)):(i(0),s(0)):e.length>0&&(i(0),s(0))},z=()=>{r!==null?r>0?(i(r-1),s(0)):(i(e.length-1),s(0)):e.length>0&&(i(e.length-1),s(0))},A=R=>{const E=m.current[R];E&&(E.paused?E.play():E.pause(),d(E.paused),f(E.paused))},I=R=>{const E=m.current[R];E&&(E.muted=!E.muted,a(L=>({...L,[R]:E.muted})))},C=R=>{clearTimeout(x.current)},_=(R,E)=>{R===0&&(v(E.duration),P(E.duration))},P=R=>{clearTimeout(x.current),x.current=setTimeout(()=>{h(!0),setTimeout(()=>{h(!1)},1e4)},R*1e3)},N=R=>{clearTimeout(x.current),R===0&&g&&P(g)},V=()=>{clearTimeout(x.current)},$=()=>{b(!w)},W=R=>{const E=R.split(`
`);return E.length>2?{truncated:E.slice(0,2).join(`
`),hasMore:!0}:{truncated:R,hasMore:!1}};return k.useEffect(()=>{s(0),S.current&&(S.current.scrollTop=0)},[r]),y.jsxs("div",{className:"whole123",children:[y.jsx("div",{className:"prevbtn123",onClick:z,children:y.jsx(Y,{icon:oi})}),y.jsx("div",{className:"nextbtn123",onClick:T,children:y.jsx(Y,{icon:ii})}),y.jsx("div",{className:"reelsContainer",ref:S,children:e[r].videoId.map((R,E)=>y.jsxs("div",{className:"reel",children:[y.jsx("div",{className:"closediv123",children:y.jsx("button",{className:"closebtn123",onClick:n,children:y.jsx(Y,{icon:rr})})}),y.jsxs("div",{className:"video-container1",children:[y.jsx("video",{ref:L=>m.current[E]=L,src:R,className:"ad",loop:!0,playsInline:!0,controls:!1,autoPlay:E===o,onClick:()=>A(E),onPause:()=>{V(),d(!0)},onPlay:()=>{N(E),d(!1)},onEnded:()=>C(),onLoadedMetadata:L=>_(E,L.target)}),u&&c&&y.jsx(Y,{icon:Ro,onClick:()=>A(E),className:"play-button123"}),y.jsxs("div",{className:"bookdiv123",children:[y.jsx("div",{className:"img1",children:y.jsx("img",{className:"img",src:e[r].campaignPhoto,alt:"Campaign"})}),y.jsxs("div",{style:{fontFamily:"Poppins, sans-serif"},className:"text",children:[y.jsx("p",{style:{fontFamily:"Poppins, sans-serif"},className:"hotelname",children:e[r].campaignName}),y.jsxs("pre",{style:{fontFamily:"Poppins, sans-serif"},className:"offer",children:[w?e[r].campaignDetails:W(e[r].campaignDetails).truncated,W(e[r].campaignDetails).hasMore&&y.jsx("div",{children:y.jsx("span",{style:{fontFamily:"Poppins, sans-serif"},className:"view-more",onClick:$,children:w?" View Less":" View More"})})]}),y.jsxs("h2",{style:{fontFamily:"Poppins, sans-serif"},className:"offerprice",children:["From ",e[r].offerPrice.currency,e[r].offerPrice.price]})]}),y.jsx("div",{className:"divbtn",children:y.jsx("a",{href:e[r].hotelInfo.hotellink,target:"_blank",rel:"noopener noreferrer",className:"bookbtn",children:"Book"})})]})]}),y.jsx("div",{className:"functions",children:y.jsx(Y,{icon:l[E]?nr:tr,className:"volume123",onClick:()=>I(E),style:{cursor:"pointer"}})})]},E))})]})},Ay=()=>{const[e,t]=k.useState([]),[n,r]=k.useState([]),[i,o]=k.useState(!0);return k.useEffect(()=>{const l=document.getElementById("root-stack").dataset.campaignId;(async u=>{try{const p=await(await fetch(`https://www.tripbuilder.in/php/shoppable.php/getCampaignsForHotel/${u}`)).json(),h=p.campaigns.map(g=>g.videoId[0]);t(h),r(p.campaigns)}catch(d){console.error("Error fetching data:",d)}})(l)},[]),k.useEffect(()=>{n.length>0&&o(!1)},[n]),y.jsxs("div",{className:"App",children:[y.jsx(ky,{videos:e,campaigns:n,loading:i})," "]})},Ty=()=>y.jsx("div",{className:"video-container123 skeleton-container",children:y.jsx("div",{className:"video-content",children:y.jsx("p",{className:"txt2-123"})})}),Py=({videos:e,campaigns:t,loading:n})=>{const r=k.useRef(null);k.useRef([]);const[i,o]=k.useState(null),[s,l]=k.useState(null),a=h=>{o(h)},u=()=>{o(null)},d=()=>{r.current.scrollBy({left:-r.current.clientWidth,behavior:"smooth"})},p=()=>{r.current.scrollBy({left:r.current.clientWidth,behavior:"smooth"})};return n?y.jsx("div",{className:"carousel-container",children:y.jsx("div",{className:"carousel",children:Array.from({length:5}).map((h,g)=>y.jsx(Ty,{},g))})}):y.jsxs("div",{className:"carousel-container",children:[y.jsx("button",{className:"nav-btn",onClick:d,children:"<"}),y.jsx("div",{className:"carousel",ref:r,children:t.map((h,g)=>y.jsxs("div",{className:"video-container123",onClick:()=>a(g),onMouseEnter:()=>l(g),onMouseLeave:()=>l(null),children:[s===g?y.jsx("video",{src:h.videoId[0],loop:!0,muted:!0,autoPlay:!0,playsInline:!0,className:"vid"}):y.jsx("img",{className:"thumbnail",src:h.campaignPhoto,width:"300",height:"200",alt:"video thumbnail"}),y.jsx("div",{className:"video-content",children:y.jsxs("p",{className:"txt",children:[t[g].campaignName," ",y.jsx("br",{})," From"," ",t[g].offerPrice.currency,t[g].offerPrice.price]})})]},g))}),y.jsx("button",{className:"nav-btn",onClick:p,children:">"}),i!==null&&y.jsx(Ny,{campaigns:t,currentIndex:i,onClose:u})]})},Ny=({campaigns:e,currentIndex:t,onClose:n})=>{const[r,i]=k.useState(t),[o,s]=k.useState(0),[l,a]=k.useState({}),[u,d]=k.useState(!1),[p,h]=k.useState(!1),[g,v]=k.useState(null),[w,b]=k.useState(!1),[c,f]=k.useState(!1),m=k.useRef([]),x=k.useRef(null),S=k.useRef(null),T=k.useRef(null),z=window.innerWidth<=450;k.useEffect(()=>{const j=new IntersectionObserver(O=>{O.forEach(Q=>{const Ye=m.current.indexOf(Q.target);Q.isIntersecting?(Q.target.play(),s(Ye),f(!1)):Q.target.pause()})},{threshold:.5});return s(0),m.current.forEach(O=>{O&&j.observe(O)}),()=>{m.current.forEach(O=>{O&&j.unobserve(O)})}},[r]),k.useEffect(()=>{const j=m.current[o];j&&j.play()},[o]);const A=()=>{r!==null?r+1<e.length?(i(r+1),s(0)):(i(0),s(0)):e.length>0&&(i(0),s(0))},I=()=>{r!==null?r>0?(i(r-1),s(0)):(i(e.length-1),s(0)):e.length>0&&(i(e.length-1),s(0))},C=j=>{const O=m.current[j];O&&(O.paused?O.play():O.pause(),d(O.paused),f(O.paused))},_=j=>{const O=m.current[j];O&&(O.muted=!O.muted,a(Q=>({...Q,[j]:O.muted})))},P=j=>{clearTimeout(x.current)},N=(j,O)=>{j===0&&(v(O.duration),V(O.duration))},V=j=>{clearTimeout(x.current),x.current=setTimeout(()=>{h(!0),setTimeout(()=>{h(!1)},1e4)},j*1e3)},$=j=>{clearTimeout(x.current),j===0&&g&&V(g)},W=()=>{clearTimeout(x.current)},R=()=>{b(!w)},E=j=>{const O=j.split(`
`);return O.length>2?{truncated:O.slice(0,2).join(`
`),hasMore:!0}:{truncated:j,hasMore:!1}},L=()=>{z&&S.current&&(S.current.requestFullscreen?S.current.requestFullscreen():S.current.mozRequestFullScreen?S.current.mozRequestFullScreen():S.current.webkitRequestFullscreen?S.current.webkitRequestFullscreen():S.current.msRequestFullscreen&&S.current.msRequestFullscreen())},B=()=>{document.exitFullscreen?document.exitFullscreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitExitFullscreen?document.webkitExitFullscreen():document.msExitFullscreen&&document.msExitFullscreen()};return k.useEffect(()=>{L();const j=()=>{document.fullscreenElement||n()};return document.addEventListener("fullscreenchange",j),()=>{document.removeEventListener("fullscreenchange",j),document.fullscreenElement&&B()}},[n]),k.useEffect(()=>{s(0),T.current&&(T.current.scrollTop=0)},[r]),y.jsxs("div",{className:"whole123",children:[y.jsx("div",{className:"prevbtn123",onClick:I,children:y.jsx(Y,{icon:oi})}),y.jsx("div",{className:"nextbtn123",onClick:A,children:y.jsx(Y,{icon:ii})}),y.jsx("div",{className:"reelsContainer",ref:T,children:e[r].videoId.map((j,O)=>y.jsxs("div",{className:"reel",children:[y.jsx("div",{className:"closediv123",children:y.jsx("button",{className:"closebtn123",onClick:n,children:y.jsx(Y,{icon:rr})})}),y.jsxs("div",{className:"video-container1",children:[y.jsx("video",{ref:Q=>m.current[O]=Q,src:j,className:"ad",loop:!0,playsInline:!0,controls:!1,autoPlay:O===o,onClick:()=>C(O),onPause:()=>{W(),d(!0)},onPlay:()=>{$(O),d(!1)},onEnded:()=>P(),onLoadedMetadata:Q=>N(O,Q.target)}),u&&c&&y.jsx(Y,{icon:Ro,onClick:()=>C(O),className:"play-button123"}),y.jsxs("div",{className:"bookdiv123",children:[y.jsx("div",{className:"img1",children:y.jsx("img",{className:"img",src:e[r].campaignPhoto,alt:"Campaign"})}),y.jsxs("div",{style:{fontFamily:"Poppins, sans-serif"},className:"text",children:[y.jsx("p",{style:{fontFamily:"Poppins, sans-serif"},className:"hotelname",children:e[r].campaignName}),y.jsxs("pre",{style:{fontFamily:"Poppins, sans-serif"},className:"offer",children:[w?e[r].campaignDetails:E(e[r].campaignDetails).truncated,E(e[r].campaignDetails).hasMore&&y.jsx("div",{children:y.jsx("span",{style:{fontFamily:"Poppins, sans-serif"},className:"view-more",onClick:R,children:w?" View Less":" View More"})})]}),y.jsxs("h2",{style:{fontFamily:"Poppins, sans-serif"},className:"offerprice",children:["From ",e[r].offerPrice.currency,e[r].offerPrice.price]})]}),y.jsx("div",{className:"divbtn",children:y.jsx("a",{href:e[r].hotelInfo.hotellink,target:"_blank",rel:"noopener noreferrer",className:"bookbtn",children:"Book"})})]})]}),y.jsx("div",{className:"functions",children:y.jsx(Y,{icon:l[O]?nr:tr,className:"volume123",onClick:()=>_(O),style:{cursor:"pointer"}})})]},O))})]})},zy=()=>{const[e,t]=k.useState([]),[n,r]=k.useState([]),[i,o]=k.useState(!0);return k.useEffect(()=>{const l=document.getElementById("root-carosole").dataset.campaignId;l?(async u=>{try{const p=await(await fetch(`https://www.tripbuilder.in/php/shoppable.php/getCampaignsForHotel/${u}`)).json(),h=p.campaigns.map(g=>g.videoId[0]);t(h),r(p.campaigns)}catch(d){console.error("Error fetching data:",d)}})(l):console.error("No campaign ID found")},[]),k.useEffect(()=>{n.length>0&&o(!1)},[n]),y.jsxs("div",{className:"App",children:[y.jsx("style",{children:`
       .skeleton-container {
     background: #e9e9e9;
...
`}),y.jsxs("div",{className:"popupVideo",children:[y.jsx("div",{className:"popu-close-button",onClick:t,children:y.jsx(Y,{icon:rr})}),y.jsx("video",{ref:s,src:u,autoPlay:!0,loop:!0,muted:n,onClick:()=>l(0)}),y.jsx("div",{className:"mute-unmute-button",onClick:d,children:y.jsx(Y,{className:"mute",icon:n?nr:tr})})]})]})]})},Iy=({campaigns:e,currentIndex:t,onClose:n})=>{const[r,i]=k.useState(t),[o,s]=k.useState(0),[l,a]=k.useState({}),[u,d]=k.useState(!1),[p,h]=k.useState(!1),[g,v]=k.useState(null),[w,b]=k.useState(!1),[c,f]=k.useState(!1),m=k.useRef([]),x=k.useRef(null),S=k.useRef(null),T=k.useRef(null),z=window.innerWidth<=450;k.useEffect(()=>{const j=new IntersectionObserver(O=>{O.forEach(Q=>{const Ye=m.current.indexOf(Q.target);Q.isIntersecting?(Q.target.play(),s(Ye),f(!1)):Q.target.pause()})},{threshold:.5});return s(0),m.current.forEach(O=>{O&&j.observe(O)}),()=>{m.current.forEach(O=>{O&&j.unobserve(O)})}},[r]),k.useEffect(()=>{const j=m.current[o];j&&j.play()},[o]);const A=()=>{r!==null?r+1<e.length?(i(r+1),s(0)):(i(0),s(0)):e.length>0&&(i(0),s(0))},I=()=>{r!==null?r>0?(i(r-1),s(0)):(i(e.length-1),s(0)):e.length>0&&(i(e.length-1),s(0))},C=j=>{const O=m.current[j];O&&(O.paused?O.play():O.pause(),d(O.paused),f(O.paused))},_=j=>{const O=m.current[j];O&&(O.muted=!O.muted,a(Q=>({...Q,[j]:O.muted})))},P=j=>{clearTimeout(x.current)},N=(j,O)=>{j===0&&(v(O.duration),V(O.duration))},V=j=>{clearTimeout(x.current),x.current=setTimeout(()=>{h(!0),setTimeout(()=>{h(!1)},1e4)},j*1e3)},$=j=>{clearTimeout(x.current),j===0&&g&&V(g)},W=()=>{clearTimeout(x.current)},R=()=>{b(!w)},E=j=>{const O=j.split(`
`);return O.length>2?{truncated:O.slice(0,2).join(`
`),hasMore:!0}:{truncated:j,hasMore:!1}},L=()=>{z&&S.current&&(S.current.requestFullscreen?S.current.requestFullscreen():S.current.mozRequestFullScreen?S.current.mozRequestFullScreen():S.current.webkitRequestFullscreen?S.current.webkitRequestFullscreen():S.current.msRequestFullscreen&&S.current.msRequestFullscreen())},B=()=>{document.exitFullscreen?document.exitFullscreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitExitFullscreen?document.webkitExitFullscreen():document.msExitFullscreen&&document.msExitFullscreen()};return k.useEffect(()=>{L();const j=()=>{document.fullscreenElement||n()};return document.addEventListener("fullscreenchange",j),()=>{document.removeEventListener("fullscreenchange",j),document.fullscreenElement&&B()}},[n]),k.useEffect(()=>{s(0),T.current&&(T.current.scrollTop=0)},[r]),y.jsxs("div",{className:"whole123",ref:S,children:[y.jsx("div",{className:"prevbtn123",onClick:I,children:y.jsx(Y,{icon:oi})}),y.jsx("div",{className:"nextbtn123",onClick:A,children:y.jsx(Y,{icon:ii})}),y.jsx("div",{className:"reelsContainer",ref:T,children:e[r].videoId.map((j,O)=>y.jsxs("div",{className:"reel",children:[y.jsx("div",{className:"closediv123",children:y.jsx("button",{className:"closebtn123",onClick:n,children:y.jsx(Y,{icon:rr})})}),y.jsxs("div",{className:"video-container1",children:[y.jsx("video",{ref:Q=>m.current[O]=Q,src:j,className:"ad",loop:!0,playsInline:!0,controls:!1,autoPlay:O===o,onClick:()=>C(O),onPause:()=>{W(),d(!0)},onPlay:()=>{$(O),d(!1)},onEnded:()=>P(),onLoadedMetadata:Q=>N(O,Q.target)}),u&&c&&y.jsx(Y,{icon:Ro,onClick:()=>C(O),className:"play-button123"}),y.jsxs("div",{className:"bookdiv123",children:[y.jsx("div",{className:"img1",children:y.jsx("img",{className:"img",src:e[r].campaignPhoto,alt:"Campaign"})}),y.jsxs("div",{style:{fontFamily:"Poppins, sans-serif"},className:"text",children:[y.jsx("p",{style:{fontFamily:"Poppins, sans-serif"},className:"hotelname",children:e[r].campaignName}),y.jsxs("pre",{style:{fontFamily:"Poppins, sans-serif"},className:"offer",children:[w?e[r].campaignDetails:E(e[r].campaignDetails).truncated,E(e[r].campaignDetails).hasMore&&y.jsx("div",{children:y.jsx("span",{style:{fontFamily:"Poppins, sans-serif"},className:"view-more",onClick:R,children:w?" View Less":" View More"})})]}),y.jsxs("h2",{style:{fontFamily:"Poppins, sans-serif"},className:"offerprice",children:["From ",e[r].offerPrice.currency,e[r].offerPrice.price]})]}),y.jsx("div",{className:"divbtn",children:y.jsx("a",{href:e[r].hotelInfo.hotellink,target:"_blank",rel:"noopener noreferrer",className:"bookbtn",children:"Book"})})]})]}),y.jsx("div",{className:"functions",children:y.jsx(Y,{icon:l[O]?nr:tr,className:"volume123",onClick:()=>_(O),style:{cursor:"pointer"}})})]},O))})]})};function My(){const[e,t]=k.useState([]),[n,r]=k.useState(!0);k.useEffect(()=>{const s=document.getElementById("root-popup").dataset.campaignId;s?(async a=>{try{const d=await(await fetch(`https://www.tripbuilder.in/php/shoppable.php/getCampaignsForHotel/${a}`)).json();t(d.campaigns),console.log(d.campaigns[0].campaignDetails)}catch(u){console.error("Error fetching data:",u)}})(s):console.log("No campaign ID found!")},[]);const i=()=>{r(!1),console.log("close button")};return y.jsx(y.Fragment,{children:n&&y.jsx(im,{campaigns:e,onClose:i})})}const Ns=document.getElementById("root-stories"),zs=document.getElementById("root-grid"),Is=document.getElementById("root-carosole"),Ms=document.getElementById("root-stack"),Os=document.getElementById("root-popup");Ns&&Ns.dataset.name==="stories"&&un.createRoot(Ns).render(y.jsx(K.StrictMode,{children:y.jsx(Uv,{})}));zs&&zs.dataset.name==="grid"&&un.createRoot(zs).render(y.jsx(K.StrictMode,{children:y.jsx(Bv,{})}));Is&&Is.dataset.name==="carosole"&&un.createRoot(Is).render(y.jsx(K.StrictMode,{children:y.jsx(zy,{})}));Ms&&Ms.dataset.name==="stack"&&un.createRoot(Ms).render(y.jsx(K.StrictMode,{children:y.jsx(Ay,{})}));Os&&Os.dataset.name==="popup"&&un.createRoot(Os).render(y.jsx(K.StrictMode,{children:y.jsx(My,{})}));
