...
`}),w.jsxs("div",{className:"popupVideo",children:[w.jsx("div",{className:"popu-close-button",onClick:t,children:w.jsx(U,{icon:nr})}),w.jsx("video",{ref:s,src:c,autoPlay:!0,loop:!0,muted:n,onClick:()=>l(0)}),w.jsx("div",{className:"mute-unmute-button",onClick:f,children:w.jsx(U,{className:"mute",icon:n?tr:er})})]})]})]})},Ty=({campaigns:e,currentIndex:t,onClose:n})=>{const[r,i]=T.useState(t),[o,s]=T.useState(0),[l,a]=T.useState({}),[c,f]=T.useState(!1),[p,h]=T.useState(!1),[g,v]=T.useState(null),[y,b]=T.useState(!1),u=T.useRef([]),d=T.useRef(null),m=T.useRef(null),x=window.innerWidth<=450;T.useEffect(()=>{const k=new IntersectionObserver(C=>{C.forEach(F=>{const W=u.current.indexOf(F.target);F.isIntersecting?(F.target.play(),s(W)):F.target.pause()})},{threshold:.5});return s(0),u.current.forEach(C=>{C&&k.observe(C)}),()=>{u.current.forEach(C=>{C&&k.unobserve(C)})}},[r]),T.useEffect(()=>{const k=u.current[o];k&&k.play()},[o]);const S=()=>{const k=(r+1)%e.length;s(0),i(k),h(!1),clearTimeout(d.current)},P=()=>{const k=(r-1+e.length)%e.length;i(k),s(0),h(!1),clearTimeout(d.current)},M=k=>{const C=u.current[k];C&&(C.paused?C.play():C.pause(),f(C.paused))},A=k=>{const C=u.current[k];C&&(C.muted=!C.muted,a(F=>({...F,[k]:C.muted})))},L=k=>{clearTimeout(d.current)},E=(k,C)=>{k===0&&(v(C.duration),z(C.duration))},z=k=>{clearTimeout(d.current),d.current=setTimeout(()=>{h(!0),setTimeout(()=>{h(!1)},1e4)},k*1e3)},I=k=>{clearTimeout(d.current),k===0&&g&&z(g)},j=()=>{clearTimeout(d.current)},O=()=>{b(!y)},N=k=>{const C=k.split(`
`);return C.length>2?{truncated:C.slice(0,2).join(`
`),hasMore:!0}:{truncated:k,hasMore:!1}},V=()=>{x&&m.current&&(m.current.requestFullscreen?m.current.requestFullscreen():m.current.mozRequestFullScreen?m.current.mozRequestFullScreen():m.current.webkitRequestFullscreen?m.current.webkitRequestFullscreen():m.current.msRequestFullscreen&&m.current.msRequestFullscreen())},oe=()=>{document.exitFullscreen?document.exitFullscreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitExitFullscreen?document.webkitExitFullscreen():document.msExitFullscreen&&document.msExitFullscreen()};return T.useEffect(()=>{V();const k=()=>{document.fullscreenElement||n()};return document.addEventListener("fullscreenchange",k),()=>{document.removeEventListener("fullscreenchange",k),document.fullscreenElement&&oe()}},[n]),T.useEffect(()=>{s(0)},[r]),w.jsxs("div",{className:"whole123",ref:m,children:[w.jsx("div",{className:"prevbtn123",onClick:P,children:w.jsx(U,{icon:ii})}),w.jsx("div",{className:"nextbtn123",onClick:S,children:w.jsx(U,{icon:ri})}),w.jsx("div",{className:"reelsContainer",children:e[r].videoId.map((k,C)=>w.jsxs("div",{className:"reel",children:[w.jsx("div",{className:"closediv123",children:w.jsx("button",{className:"closebtn123",onClick:n,children:w.jsx(U,{icon:nr})})}),w.jsxs("div",{className:"video-container1",children:[w.jsx("video",{ref:F=>u.current[C]=F,src:k,className:"ad",loop:!0,playsInline:!0,controls:!1,autoPlay:C===o,onClick:()=>M(C),onPause:()=>{j(),f(!0)},onPlay:()=>{I(C),f(!1)},onEnded:()=>L(),onLoadedMetadata:F=>E(C,F.target)}),c&&w.jsx(U,{icon:Ro,onClick:()=>M(C),className:"play-button123"}),w.jsxs("div",{className:"bookdiv123",children:[w.jsx("div",{className:"img1",children:w.jsx("img",{className:"img",src:e[r].campaignPhoto,alt:"Campaign"})}),w.jsxs("div",{style:{fontFamily:"Poppins, sans-serif"},className:"text",children:[w.jsx("p",{style:{fontFamily:"Poppins, sans-serif"},className:"hotelname",children:e[r].campaignName}),w.jsxs("pre",{style:{fontFamily:"Poppins, sans-serif"},className:"offer",children:[y?e[r].campaignDetails:N(e[r].campaignDetails).truncated,N(e[r].campaignDetails).hasMore&&w.jsx("div",{children:w.jsx("span",{style:{fontFamily:"Poppins, sans-serif"},className:"view-more",onClick:O,children:y?" View Less":" View More"})})]}),w.jsxs("h2",{style:{fontFamily:"Poppins, sans-serif"},className:"offerprice",children:["From ",e[r].offerPrice.currency,e[r].offerPrice.price]})]}),w.jsx("div",{className:"divbtn",children:w.jsx("a",{href:e[r].hotelInfo.hotellink,target:"_blank",rel:"noopener noreferrer",className:"bookbtn",children:"Book"})})]})]}),w.jsx("div",{className:"functions",children:w.jsx(U,{icon:l[C]?tr:er,className:"volume123",onClick:()=>A(C),style:{cursor:"pointer"}})})]},C))})]})};function Py(){const[e,t]=T.useState([]),[n,r]=T.useState(!0);T.useEffect(()=>{const s=document.getElementById("root-popup").dataset.campaignId;s?(async a=>{try{const f=await(await fetch(`https://www.tripbuilder.in/php/shoppable.php/getCampaignsForHotel/${a}`)).json();t(f.campaigns),console.log(f.campaigns[0].campaignDetails)}catch(c){console.error("Error fetching data:",c)}})(s):console.log("No campaign ID found!")},[]);const i=()=>{r(!1),console.log("close button")};return w.jsx(w.Fragment,{children:n&&w.jsx(im,{campaigns:e,onClose:i})})}const zs=document.getElementById("root-stories"),Ns=document.getElementById("root-grid"),Is=document.getElementById("root-carosole"),Ms=document.getElementById("root-stack"),Os=document.getElementById("root-popup");zs&&zs.dataset.name==="stories"&&an.createRoot(zs).render(w.jsx(Y.StrictMode,{children:w.jsx($0,{})}));Ns&&Ns.dataset.name==="grid"&&an.createRoot(Ns).render(w.jsx(Y.StrictMode,{children:w.jsx(V0,{})}));Is&&Is.dataset.name==="carosole"&&an.createRoot(Is).render(w.jsx(Y.StrictMode,{children:w.jsx(Ay,{})}));Ms&&Ms.dataset.name==="stack"&&an.createRoot(Ms).render(w.jsx(Y.StrictMode,{children:w.jsx(Ey,{})}));Os&&Os.dataset.name==="popup"&&an.createRoot(Os).render(w.jsx(Y.StrictMode,{children:w.jsx(Py,{})}));
