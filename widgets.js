...
`}),y.jsx(D0,{videos:e,campaigns:n,loading:i,widgetsDiv:s})]})},B0=({campaigns:e,loading:t})=>{const n=P.useRef(null),[r,i]=P.useState(!1),[o,s]=P.useState(null),[l,a]=P.useState(0),[c,f]=P.useState(!1),[p,m]=P.useState(0),[g,v]=P.useState({}),[w,k]=P.useState(!1);P.useEffect(()=>{const C=()=>{document.hidden&&n.current&&(n.current.muted=!0,f(!0))};return document.addEventListener("visibilitychange",C),()=>{document.removeEventListener("visibilitychange",C)}},[]),P.useEffect(()=>{const C=n.current,N=()=>{k(C.paused),C.paused&&C.play()};return C&&(C.addEventListener("play",N),C.addEventListener("pause",N)),()=>{C&&(C.removeEventListener("play",N),C.removeEventListener("pause",N))}},[o,l,e]),P.useEffect(()=>{if(o!==null&&e[o]){const C=e[o];if(l<C.videoId.length){const N=C.videoId[l];n.current.src=N,n.current.play(),m(0),k(!1)}}},[o,l,e]),P.useEffect(()=>{const C=setInterval(()=>{n.current&&m(n.current.currentTime/n.current.duration*100)},100);return()=>clearInterval(C)},[l,o]),P.useEffect(()=>{n.current&&(n.current.muted=c)},[c]);const u=C=>{s(C),a(0)},d=()=>{if(v(C=>({...C,[`${o}-${l}`]:!0})),m(100),o!==null&&e[o]){const C=e[o];l+1<C.videoId.length?a(l+1):o+1<e.length?(s(o+1),a(0)):(s(null),a(0))}},h=()=>{o!==null?o+1<e.length?(s(o+1),a(0)):(s(0),a(0)):e.length>0&&(s(0),a(0))},x=()=>{o!==null?o>0?(s(o-1),a(0)):(s(e.length-1),a(0)):e.length>0&&(s(e.length-1),a(0))},E=()=>{o!==null&&e[o]&&l+1<e[o].videoId.length&&(v(C=>({...C,[`${o}-${l}`]:!0})),a(l+1))},T=()=>{o!==null&&e[o]&&l>0&&a(l-1)},z=()=>{f(C=>!C)},A=()=>{s(null),a(0),k(!1),f(!1)},M=C=>{const N=C.currentTarget.getBoundingClientRect(),F=C.clientX-N.left,$=N.width;F<$/2?T():E()},S=()=>{i(!r)},b=C=>{const N=C.split(`
`);return N.length>2?{truncated:N.slice(0,2).join(`
`),hasMore:!0}:{truncated:C,hasMore:!1}};return y.jsx(y.Fragment,{children:y.jsxs("div",{className:"storiesHeader",children:[y.jsx("div",{className:"outer",children:e.map((C,N)=>y.jsx("div",{onClick:()=>u(N),className:`inner ${o===N?"active":""} ${C.videoId.some((F,$)=>g[`${N}-${$}`])?"played":"not-played"}`,children:y.jsx("img",{src:C.campaignPhoto,alt:"Campaign",className:"campaign-photo"})},N))}),y.jsxs("div",{className:`topp ${o!==null?"active":""}`,children:[y.jsx("div",{className:"next",onClick:h,children:y.jsx(ne,{icon:Lo})}),y.jsx("div",{className:"previous",onClick:x,children:y.jsx(ne,{icon:Do})}),y.jsx("div",{className:"outer-box",children:o!==null&&y.jsxs("div",{className:"boxed-video",children:[y.jsx("div",{className:"mute-unmute",onClick:z,children:c?y.jsx(ne,{icon:_o}):y.jsx(ne,{icon:Oo})}),y.jsx("div",{className:"close-button",onClick:A,children:y.jsx(ne,{className:"close",icon:jo})}),y.jsx("div",{className:"progress-bar",children:e[o].videoId.map((C,N)=>y.jsx("div",{className:"progress",children:y.jsx("div",{className:"progress1",style:{width:`${N===l?p:g[`${o}-${N}`]?100:0}%`}})},N))}),y.jsx("video",{className:"boxed-video",ref:n,onClick:M,onEnded:d,autoPlay:!0,children:"Your browser does not support the video tag."}),y.jsxs("div",{className:"bookdiv",children:[y.jsx("div",{className:"img1",children:y.jsx("img",{className:"img",src:e[o].campaignPhoto,alt:"Campaign"})}),y.jsxs("div",{style:{fontFamily:"Poppins, sans-serif"},className:"text",children:[y.jsx("p",{style:{fontFamily:"Poppins, sans-serif"},className:"hotelname",children:e[o].campaignName}),y.jsxs("pre",{style:{fontFamily:"Poppins, sans-serif"},className:"offer",children:[r?e[o].campaignDetails:b(e[o].campaignDetails).truncated,b(e[o].campaignDetails).hasMore&&y.jsx("div",{children:y.jsx("span",{style:{fontFamily:"Poppins, sans-serif"},className:"view-more",onClick:S,children:r?" View Less":" View More"})})]}),y.jsxs("div",{className:"bottom-div",children:[" ",y.jsxs("h2",{style:{fontFamily:"Poppins, sans-serif"},className:"offerprice",children:["From"," ",e[o].offerPrice.currency,e[o].offerPrice.price]}),y.jsx("div",{className:"divbtn",children:y.jsx("a",{href:e[o].campaignLink,target:"_blank",rel:"noopener noreferrer",className:"bookbtn",children:"Book"})})]})]})]})]})})]})]})})};function V0(){P.useState([]);const[e,t]=P.useState([]);P.useState("");const[n,r]=P.useState(!0);return P.useEffect(()=>{const o=document.getElementById("root-stories").dataset.campaignId;o?(async l=>{try{const c=await(await fetch(`https://widgetapi.tripbuilder.in/${l}`)).json();t(c.campaigns)}catch(a){console.error("Error fetching data:",a)}})(o):console.log("no campaign id found!")},[]),P.useEffect(()=>{e.length>0&&r(!1)},[e]),y.jsxs("div",{className:"App1",children:[y.jsx("style",{children:`
...
`}),y.jsx(Sy,{videos:e,campaigns:n,loading:i,widgetsDiv:s})," "]})},ky=()=>y.jsx("div",{className:"video-container123 skeleton-container",children:y.jsx("div",{className:"video-content",children:y.jsx("p",{className:"txt2-123"})})}),Cy=({videos:e,campaigns:t,loading:n,widgetsDiv:r})=>{const i=P.useRef(null),[o,s]=P.useState(null),[l,a]=P.useState(null),c=w=>{s(w)},f=()=>{s(null)},p=()=>{i.current.scrollBy({left:-i.current.clientWidth,behavior:"smooth"})},m=()=>{i.current.scrollBy({left:i.current.clientWidth,behavior:"smooth"})},g=w=>{a(w)},v=()=>{a(null)};return n?y.jsx("div",{className:"carousel-container",children:y.jsx("div",{className:"carousel",children:Array.from({length:5}).map((w,k)=>y.jsx(ky,{},k))})}):y.jsxs("div",{className:"carousel-container",children:[y.jsx("button",{className:"nav-btn",onClick:p,children:"<"}),y.jsx("div",{className:"carousel",ref:i,children:t.map((w,k)=>{var u,d,h,x,E;return y.jsxs("div",{className:"video-container123",onClick:()=>c(k),onMouseEnter:()=>g(k),onMouseLeave:v,onTouchStart:()=>g(k),onTouchEnd:v,children:[l===k?y.jsx("video",{src:w.videoId[0],loop:!0,muted:!0,autoPlay:!0,playsInline:!0,className:"vid"}):y.jsx("img",{className:"thumbnail",src:w.campaignPhoto,width:"300",height:"200",alt:"video thumbnail"}),r?y.jsxs("div",{className:"widgetsDivBookdiv123",children:[y.jsx("div",{className:"img1 widgetsDivImg1",children:y.jsx("img",{className:"img widgetsDivImg",src:w.campaignPhoto,alt:"Campaign"})}),y.jsxs("div",{style:{fontFamily:"Poppins, sans-serif"},className:"text",children:[y.jsx("p",{style:{fontFamily:"Poppins, sans-serif"},className:"hotelname widgetsDivHotelname",children:w.campaignName}),y.jsx("pre",{style:{fontFamily:"Poppins, sans-serif"},className:"offer"}),y.jsxs("h2",{style:{fontFamily:"Poppins, sans-serif"},className:"widgetsDivOfferprice",children:["From ",w.offerPrice.currency,w.offerPrice.price]})]}),y.jsx("div",{className:"divbtn",children:y.jsx("a",{href:w.campaignLink,target:"_blank",rel:"noopener noreferrer",className:"bookbtn widgetsDivBookbtn",children:"Book"})})]}):y.jsx("div",{className:"video-content",children:y.jsxs("p",{className:"txt",children:[((u=t[k])==null?void 0:u.campaignName)&&y.jsxs(y.Fragment,{children:[t[k].campaignName,y.jsx("br",{})]}),((h=(d=t[k])==null?void 0:d.offerPrice)==null?void 0:h.currency)&&((E=(x=t[k])==null?void 0:x.offerPrice)==null?void 0:E.price)&&y.jsxs(y.Fragment,{children:["From ",t[k].offerPrice.currency,t[k].offerPrice.price]})]})})]},k)})}),y.jsx("button",{className:"nav-btn",onClick:m,children:">"}),o!==null&&y.jsx(Ay,{campaigns:t,currentIndex:o,onClose:f})]})},Ay=({campaigns:e,currentIndex:t,onClose:n})=>{const[r,i]=P.useState(t),[o,s]=P.useState(0),[l,a]=P.useState({mutedAll:!1}),[c,f]=P.useState(!1),[p,m]=P.useState(!1),[g,v]=P.useState(!1),[w,k]=P.useState(!1),u=P.useRef([]);P.useRef(null);const d=P.useRef(null);P.useEffect(()=>{const S=()=>{if(document.visibilityState==="hidden"){const b=u.current[o];b&&!b.paused&&(b.pause(),f(!0),k(!0))}};return document.addEventListener("visibilitychange",S),()=>{document.removeEventListener("visibilitychange",S)}},[o]),P.useEffect(()=>{const S=new IntersectionObserver(b=>{b.forEach(C=>{const N=u.current.indexOf(C.target);C.isIntersecting?(C.target.play(),s(N),k(!1)):C.target.pause()})},{threshold:.5});return s(0),u.current.forEach(b=>{b&&S.observe(b)}),()=>{u.current.forEach(b=>{b&&S.unobserve(b)})}},[r]),P.useEffect(()=>{const S=u.current[o];S&&S.play()},[o]);const h=()=>{r!==null?r+1<e.length?(i(r+1),s(0)):(i(0),s(0)):e.length>0&&(i(0),s(0)),m(!1)},x=()=>{r!==null?r>0?(i(r-1),s(0)):(i(e.length-1),s(0)):e.length>0&&(i(e.length-1),s(0)),m(!1)},E=S=>{const b=u.current[S];b&&(b.paused?(b.play(),console.log("Playing")):(b.pause(),console.log("Paused")),f(b.paused),k(b.paused))},T=()=>{u.current.forEach(b=>{b.muted=!l.mutedAll}),a(b=>({mutedAll:!b.mutedAll}))},z=()=>{v(!g)},A=S=>{const b=S.split(`
`);return b.length>2?{truncated:b.slice(0,2).join(`
`),hasMore:!0}:{truncated:S,hasMore:!1}},M=S=>{console.log("Video ended, checking if animation should play");const b=e[r];if(S<b.videoId.length-1)console.log("Not the last video, playing animation"),m(!0),setTimeout(()=>{const C=u.current[S];C&&(C.currentTime=0,C.play()),m(!1)},5e3);else{console.log("Last video, no animation, just restart");const C=u.current[S];C&&(C.currentTime=0,C.play())}};return P.useEffect(()=>{s(0),d.current&&(d.current.scrollTop=0)},[r]),P.useEffect(()=>{const S=()=>{m(!1)},b=d.current;return b&&b.addEventListener("scroll",S),()=>{b&&b.removeEventListener("scroll",S)}},[]),y.jsxs("div",{className:"whole123",children:[y.jsx("div",{className:"prevbtn123",onClick:x,children:y.jsx(ne,{icon:Do})}),y.jsx("div",{className:"nextbtn123",onClick:h,children:y.jsx(ne,{icon:Lo})}),y.jsxs("div",{className:"reelsContainer",ref:d,children:[e[r].videoId.map((S,b)=>y.jsx("div",{className:"reel",children:y.jsxs("div",{className:"video-container1",children:[y.jsx("div",{className:"closediv123",children:y.jsx("button",{className:"closebtn123",onClick:n,children:y.jsx(ne,{icon:jo})})}),y.jsx("div",{className:"functions",children:y.jsx(ne,{icon:l.mutedAll?_o:Oo,className:"volume123",onClick:T,style:{cursor:"pointer"}})}),y.jsx("video",{ref:C=>u.current[b]=C,src:S,className:"ad",loop:!1,playsInline:!0,controls:!1,autoPlay:b===o,onClick:()=>E(b),onPause:()=>{f(!0)},onPlay:()=>{f(!1)},onEnded:()=>M(b)}),c&&w&&y.jsx(ne,{icon:Ba,onClick:()=>E(b),className:"play-button123"}),y.jsxs("div",{className:"bookdiv123",children:[y.jsx("div",{className:"img1",children:y.jsx("img",{className:"img",src:e[r].campaignPhoto,alt:"Campaign"})}),y.jsxs("div",{style:{fontFamily:"Poppins, sans-serif"},className:"text",children:[y.jsx("p",{style:{fontFamily:"Poppins, sans-serif"},className:"hotelname",children:e[r].campaignName}),y.jsxs("pre",{style:{fontFamily:"Poppins, sans-serif"},className:"offer",children:[g?e[r].campaignDetails:A(e[r].campaignDetails).truncated,A(e[r].campaignDetails).hasMore&&y.jsx("div",{children:y.jsx("span",{style:{fontFamily:"Poppins, sans-serif"},className:"view-more",onClick:z,children:g?" View Less":" View More"})})]}),y.jsxs("div",{className:"bottom-div",children:[" ",y.jsxs("h2",{style:{fontFamily:"Poppins, sans-serif"},className:"offerprice",children:["From ",e[r].offerPrice.currency,e[r].offerPrice.price]}),y.jsx("div",{className:"divbtn",children:y.jsx("a",{href:e[r].campaignLink,target:"_blank",rel:"noopener noreferrer",className:"bookbtn",children:"Book"})})]})]})]})]})},b)),p&&y.jsx("dotlottie-player",{src:"https://lottie.host/9dbbaa88-603c-407f-a9d4-f40ef822c697/JKZJQpvfeR.json",background:"transparent",speed:"1",style:{width:"29vh",height:"29vh",position:"absolute",bottom:"0",top:"50%",left:"50%",transform:"translate(-50%, -50%)",fontSize:"34px",color:"white",zIndex:1e3},loop:!0,autoplay:!0})]})]})},Ty=()=>{const[e,t]=P.useState([]),[n,r]=P.useState([]),[i,o]=P.useState(!0),[s,l]=P.useState(!1);return P.useEffect(()=>{const a=document.getElementById("root-carosole"),c=a.dataset.widgetStatus;l(c==="true");const f=a.dataset.campaignId;f?(async m=>{try{const v=await(await fetch(`https://widgetapi.tripbuilder.in/${m}`)).json(),w=v.campaigns.map(k=>k.videoId[0]);t(w),r(v.campaigns)}catch(g){console.error("Error fetching data:",g)}})(f):console.error("No campaign ID found")},[]),P.useEffect(()=>{n.length>0&&o(!1)},[n]),y.jsxs("div",{className:"App3",children:[y.jsx("style",{children:`
...
`}),y.jsx(Cy,{videos:e,campaigns:n,loading:i,widgetsDiv:s})," "]})},Ps=document.getElementById("root-stories"),Ns=document.getElementById("root-grid"),zs=document.getElementById("root-carosole"),Is=document.getElementById("root-stack");Ps&&Ps.dataset.name==="stories"&&Vn.createRoot(Ps).render(y.jsx(W.StrictMode,{children:y.jsx(V0,{})}));Ns&&Ns.dataset.name==="grid"&&Vn.createRoot(Ns).render(y.jsx(W.StrictMode,{children:y.jsx(R0,{})}));zs&&zs.dataset.name==="carosole"&&Vn.createRoot(zs).render(y.jsx(W.StrictMode,{children:y.jsx(Ty,{})}));Is&&Is.dataset.name==="stack"&&Vn.createRoot(Is).render(y.jsx(W.StrictMode,{children:y.jsx(Ey,{})}));
